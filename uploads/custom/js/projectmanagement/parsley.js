...
(function (global, factory) {
  ...
  Parsley.addMessages('en', {
    defaultMessage: invalid_value,
    type: {
      email: email_required,
      url: url_required,
      number: number_required,
      integer: integer_required,
      digits: digit_required,
      alphanum: numeric_value,
      alphanumdash: sign_require
    },
    notblank: not_blank,
    required: value_required,
    pattern: invalid_value,
    min: greater_equal_value,
    max: lower_value,
    range: between_value,
    minlength: short_value,
    maxlength: long_value,
    length: invalid_length_value,
    mincheck: select_one_value,
    maxcheck: select_less_value,
    check: select_between_value,
    equalto: same_value
  });
...
window.Parsley.addValidator('notequalto',
    ...
    .addMessage('en', 'notequalto', same_not_value);
...
window.Parsley.addValidator('ge',
    ...
    .addMessage('en', 'ge', grater_or_equal_value);
...
window.Parsley.addValidator('le',
    ...
    .addMessage('en', 'le', less_equal_value);
