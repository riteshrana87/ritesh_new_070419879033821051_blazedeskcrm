...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tinycon = __webpack_require__(/*! Tinycon */ 168);
	...
	var _Account = __webpack_require__(/*! Stores/User/Account */ 30);
	...
	var _Template = __webpack_require__(/*! Stores/User/Template */ 93);

	var _Template2 = _interopRequireDefault(_Template);

	var _Folder = __webpack_require__(/*! Stores/User/Folder */ 22);
	...
	var _Message = __webpack_require__(/*! Stores/User/Message */ 31);
	...
	var _Email = __webpack_require__(/*! Model/Email */ 29);

	var _Email2 = _interopRequireDefault(_Email);

	var _Account3 = __webpack_require__(/*! Model/Account */ 103);

	var _Account4 = _interopRequireDefault(_Account3);

	var _Identity3 = __webpack_require__(/*! Model/Identity */ 109);

	var _Identity4 = _interopRequireDefault(_Identity3);

	var _Template3 = __webpack_require__(/*! Model/Template */ 112);

	var _Template4 = _interopRequireDefault(_Template3);

	var _OpenPgpKey = __webpack_require__(/*! Model/OpenPgpKey */ 111);
	...
	var AppUser = (function (_AbstractApp) {
		...
		function AppUser() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AppUser).call(this, _Ajax2.default));
			...
			_common.$.wakeUp(function () {
				_Ajax2.default.jsVersion(function (sResult, oData) {
					if (Enums.StorageResultType.Success === sResult && oData && !oData.Result) {
						if (_common.window.parent && !!_Settings4.default.settingsGet('InIframe')) {
							_common.window.parent.location.reload();
						} else {
							_common.window.location.reload();
						}
					}
				}, _Settings4.default.settingsGet('Version'));
			}, {}, 60 * 60 * 1000);
			...
			if (_Settings4.default.settingsGet('UserBackgroundHash')) {
				_common._.delay(function () {
					(0, _common.$)('#rl-bg').attr('style', 'background-image: none !important;').backstretch(_Links2.default.userBackground(_Settings4.default.settingsGet('UserBackgroundHash')), {
						'fade': _Globals2.default.bAnimationSupported ? 1000 : 0, 'centeredX': true, 'centeredY': true
					}).removeAttr('style');
				}, 1000);
			}
		...
		_createClass(AppUser, [{
			key: 'remote',
			value: function remote() {
				return _Ajax2.default;
			}
		}, {
			key: 'reloadFlagsCurrentMessageListAndMessageFromCache',
			value: function reloadFlagsCurrentMessageListAndMessageFromCache() {
	   ...
	   */
			...
			key: 'reloadMessageList',
			value: function reloadMessageList() {
			...
			key: 'recacheInboxMessageList',
			value: function recacheInboxMessageList() {
	   ...
	   */
			...
			key: 'contactsSync',
			value: function contactsSync(fResultFunc) {
			...
			key: 'messagesMoveTrigger',
			value: function messagesMoveTrigger() {
				var _this2 = this;
			...
			key: 'messagesMoveHelper',
			value: function messagesMoveHelper(sFromFolderFullNameRaw, sToFolderFullNameRaw, aUidForMove) {
			...
			key: 'messagesCopyHelper',
			value: function messagesCopyHelper(sFromFolderFullNameRaw, sToFolderFullNameRaw, aUidForCopy) {
				_Ajax2.default.messagesCopy(this.moveOrDeleteResponseHelper, sFromFolderFullNameRaw, sToFolderFullNameRaw, aUidForCopy);
			}
		}, {
			key: 'messagesDeleteHelper',
			value: function messagesDeleteHelper(sFromFolderFullNameRaw, aUidForRemove) {
				_Ajax2.default.messagesDelete(this.moveOrDeleteResponseHelper, sFromFolderFullNameRaw, aUidForRemove);
			}
		}, {
			key: 'moveOrDeleteResponseHelper',
			value: function moveOrDeleteResponseHelper(sResult, oData) {
	   ...
	   */
			...
			key: 'deleteMessagesFromFolderWithoutCheck',
			value: function deleteMessagesFromFolderWithoutCheck(sFromFolderFullNameRaw, aUidForRemove) {
	   ...
	   */
			...
			key: 'deleteMessagesFromFolder',
			value: function deleteMessagesFromFolder(iDeleteType, sFromFolderFullNameRaw, aUidForRemove, bUseFolder) {
				var _this3 = this;
	   ...
	   */
			...
			key: 'moveMessagesToFolder',
			value: function moveMessagesToFolder(sFromFolderFullNameRaw, aUidForMove, sToFolderFullNameRaw, bCopy) {
	   ...
	   */
			...
			key: 'foldersPromisesActionHelper',
			value: function foldersPromisesActionHelper(promise, errorDefCode) {
			...
			key: 'reloadOpenPgpKeys',
			value: function reloadOpenPgpKeys() {
				...
				if (_Pgp2.default.capaOpenPGP()) {
					...
					_common._.each(oOpenpgpKeys, function (oItem, iIndex) {
						if (oItem && oItem.primaryKey) {
							var oPrimaryUser = oItem.getPrimaryUser(),
							...
							if (oEmail.validate()) {
								aKeys.push(new _OpenPgpKey2.default(iIndex, oItem.primaryKey.getFingerprint(), oItem.primaryKey.getKeyId().toHex().toLowerCase(), sUser, oEmail.email, oItem.isPrivate(), oItem.armor()));
							}
						}
					});
			...
			key: 'accountsAndIdentities',
			value: function accountsAndIdentities(bBoot) {
				var _this4 = this;
			...
			value: function quota() {
				_Ajax2.default.quota(function (result, data) {
					if (Enums.StorageResultType.Success === result && data && data.Result && _Utils2.default.isArray(data.Result) && 1 < data.Result.length && _Utils2.default.isPosNumeric(data.Result[0], true) && _Utils2.default.isPosNumeric(data.Result[1], true)) {
						__webpack_require__(/*! Stores/User/Quota */ 92).populateData(_Utils2.default.pInt(data.Result[1]), _Utils2.default.pInt(data.Result[0]));
					}
				});
			}
	   ...
	   */
			...
			key: 'folderInformation',
			value: function folderInformation(folder, list) {
				var _this5 = this;
					...
					_Ajax2.default.folderInformation(function (result, data) {
						if (Enums.StorageResultType.Success === result) {
							if (data && data.Result && data.Result.Hash && data.Result.Folder) {
								...
								var _folder = _Cache2.default.getFolderFromCacheList(data.Result.Folder);
								if (_folder) {
									_folder.interval = _Momentor2.default.momentNowUnix();
									...
									if (_Utils2.default.isNormal(data.Result.MessageCount)) {
										_folder.messageCountAll(data.Result.MessageCount);
									}

									if (_Utils2.default.isNormal(data.Result.MessageUnseenCount)) {
										if (_Utils2.default.pInt(_folder.messageCountUnread()) !== _Utils2.default.pInt(data.Result.MessageUnseenCount)) {
											unreadCountChange = true;
										}

										_folder.messageCountUnread(data.Result.MessageUnseenCount);
									}

									if (unreadCountChange) {
										_Cache2.default.clearMessageFlagsFromCacheByFolder(_folder.fullNameRaw);
									}
									...
									if (data.Result.Flags) {
										for (uid in data.Result.Flags) {
											if (data.Result.Flags.hasOwnProperty(uid)) {
												...
												_Cache2.default.storeMessageFlagsToCacheByFolderAndUid(_folder.fullNameRaw, uid.toString(), [!flags['IsSeen'], !!flags['IsFlagged'], !!flags['IsAnswered'], !!flags['IsForwarded'], !!flags['IsReadReceipt']]);
											}
										}
									...
									_Message2.default.initUidNextAndNewMessages(_folder.fullNameRaw, data.Result.UidNext, data.Result.NewMessages);

									var hash = _Cache2.default.getFolderHash(data.Result.Folder);
									if (data.Result.Hash !== hash || '' === hash || unreadCountChange) {
										if (_folder.fullNameRaw === _Folder2.default.currentFolderFullNameRaw()) {
											_this5.reloadMessageList();
										} else if (_Cache2.default.getFolderInboxName() === _folder.fullNameRaw) {
			...
			key: 'folderInformationMultiply',

			/**
	   * @param {boolean=} boot = false
	   */
			value: function folderInformationMultiply() {
				var _this6 = this;
	   ...
	   */
			value: function messageListAction(sFolderFullNameRaw, mUid, iSetAction, aMessages) {
	   ...
	   */
			...
			key: 'twitterDisconnect',
			value: function twitterDisconnect() {
				_Social2.default.twitter.loading(true);
	   ...
	   */
			...
			key: 'getAutocomplete',
			value: function getAutocomplete(query, callback) {
	   ...
	   */
			...
			key: 'setExpandedFolder',
			value: function setExpandedFolder(sFullNameHash, bExpanded) {
			...
			key: 'initHorizontalLayoutResizer',
			value: function initHorizontalLayoutResizer(sClientSideKeyName) {
			...
			key: 'initVerticalLayoutResizer',
			value: function initVerticalLayoutResizer(sClientSideKeyName) {
			...
			key: 'bootstartTwoFactorScreen',
			value: function bootstartTwoFactorScreen() {
				_Knoin2.default.showScreenPopup(__webpack_require__(/*! View/Popup/TwoFactorConfiguration */ 100), [true]);
			}
		}, {
			key: 'bootstartWelcomePopup',
			value: function bootstartWelcomePopup(url) {
				_Knoin2.default.showScreenPopup(__webpack_require__(/*! View/Popup/WelcomePage */ 155), [url]);
			}
		}, {
			key: 'bootstartLoginScreen',
			value: function bootstartLoginScreen() {

				_Globals2.default.$html.removeClass('rl-user-auth').addClass('rl-user-no-auth');

				var customLoginLink = _Utils2.default.pString(_Settings4.default.settingsGet('CustomLoginLink'));
				if (!customLoginLink) {
					_Knoin2.default.startScreens([__webpack_require__(/*! Screen/User/Login */ 117)]);
			...
			value: function bootstart() {
				...
				_get(Object.getPrototypeOf(AppUser.prototype), 'bootstart', this).call(this);
				...
				var $LAB = __webpack_require__(/*! $LAB */ 167),
				    sJsHash = _Settings4.default.settingsGet('JsHash'),
					...
					if (_Settings4.default.capa(Enums.Capa.TwoFactor) && _Settings4.default.capa(Enums.Capa.TwoFactorForce) && _Settings4.default.settingsGet('RequireTwoFactor')) {
						...
						this.foldersReload(function (value) {
							...
							if (value) {
									...
									(function () {
										var openpgpCallback = function openpgpCallback(openpgp) {
											...
											if (_common.window.Worker) {
												try {
													_Pgp2.default.openpgp.initWorker(_Links2.default.openPgpWorkerJs());
												} catch (e) {
								...
								_Knoin2.default.startScreens([__webpack_require__(/*! Screen/User/MailBox */ 118), _Settings4.default.capa(Enums.Capa.Settings) ? __webpack_require__(/*! Screen/User/Settings */ 119) : null, false ? require('Screen/User/About') : null]);
								...
								if (!!_Settings4.default.settingsGet('AccountSignMe') && _common.window.navigator.registerProtocolHandler && _Settings4.default.capa(Enums.Capa.Composer)) {
									_common._.delay(function () {
										...
										if (_Settings4.default.settingsGet('MailToEmail')) {
											_Utils2.default.mailToHelper(_Settings4.default.settingsGet('MailToEmail'), __webpack_require__(/*! View/Popup/Compose */ 32));
										}
									}, 500);
								}
								...
								if (!_Globals2.default.bMobileDevice) {
									...
									if (_Tinycon2.default && _Settings4.default.settingsGet('FaviconStatus') && !_Settings4.default.settingsGet('Filtered')) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Base64 = __webpack_require__(/*! Common/Base64 */ 164),

			Cache = __webpack_require__(/*! Common/Cache */ 21),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CacheUserStorage = (function () {
	   ...
	   */
			...
			key: 'getUserPic',
			value: function getUserPic(email, callback) {
	   ...
	   */
			...
			key: 'getMessageKey',
			value: function getMessageKey(folderFullNameRaw, uid) {
	   ...
	   */
			...
			key: 'addRequestedMessage',
			value: function addRequestedMessage(folder, uid) {
	   ...
	   */
			...
			key: 'hasRequestedMessage',
			value: function hasRequestedMessage(folder, uid) {
	   ...
	   */
			...
			key: 'addNewMessageCache',
			value: function addNewMessageCache(folderFullNameRaw, uid) {
	   ...
	   */
			...
			key: 'hasNewMessageAndRemoveFromCache',
			value: function hasNewMessageAndRemoveFromCache(folderFullNameRaw, uid) {
			...
			key: 'clearNewMessageCache',
			value: function clearNewMessageCache() {
				this.oNewMessage = {};
			}
	   ...
	   */
			...
			key: 'getFolderInboxName',
			value: function getFolderInboxName() {
	   ...
	   */
			...
			key: 'getFolderFullNameRaw',
			value: function getFolderFullNameRaw(folderHash) {
	   ...
	   */
			...
			key: 'setFolderFullNameRaw',
			value: function setFolderFullNameRaw(folderHash, folderFullNameRaw) {
	   ...
	   */
			...
			key: 'getFolderHash',
			value: function getFolderHash(folderFullNameRaw) {
	   ...
	   */
			...
			key: 'setFolderHash',
			value: function setFolderHash(folderFullNameRaw, folderHash) {
	   ...
	   */
			...
			key: 'getFolderUidNext',
			value: function getFolderUidNext(folderFullNameRaw) {
	   ...
	   */
			...
			key: 'setFolderUidNext',
			value: function setFolderUidNext(folderFullNameRaw, uidNext) {
	   ...
	   */
			...
			key: 'getFolderFromCacheList',
			value: function getFolderFromCacheList(folderFullNameRaw) {
	   ...
	   */
			...
			key: 'setFolderToCacheList',
			value: function setFolderToCacheList(folderFullNameRaw, folder) {
	   ...
	   */
			...
			key: 'removeFolderFromCacheList',
			value: function removeFolderFromCacheList(folderFullNameRaw) {
	   ...
	   */
			...
			key: 'getMessageFlagsFromCache',
			value: function getMessageFlagsFromCache(folderFullName, uid) {
	   ...
	   */
			...
			key: 'setMessageFlagsToCache',
			value: function setMessageFlagsToCache(folderFullName, uid, flagsCache) {
	   ...
	   */
			...
			key: 'clearMessageFlagsFromCacheByFolder',
			value: function clearMessageFlagsFromCacheByFolder(folderFullName) {
				this.oMessageFlagsCache[folderFullName] = {};
			}
	   ...
	   */
			...
			key: 'initMessageFlagsFromCache',
			value: function initMessageFlagsFromCache(message) {
				var _this = this;
					...
					(function () {
						...
						if (0 < message.threads().length) {
							var unseenSubUid = _common._.find(message.threads(), function (sSubUid) {
								if (uid !== sSubUid) {
									var _flags = _this.getMessageFlagsFromCache(message.folderFullNameRaw, sSubUid);
									return _flags && 0 < _flags.length && !!_flags[0];
								}
								return false;
							});
							...
							var flaggedSubUid = _common._.find(message.threads(), function (sSubUid) {
								if (uid !== sSubUid) {
									var _flags2 = _this.getMessageFlagsFromCache(message.folderFullNameRaw, sSubUid);
									return _flags2 && 0 < _flags2.length && !!_flags2[1];
								}
								return false;
							});
	   ...
	   */
			...
			key: 'storeMessageFlagsToCache',
			value: function storeMessageFlagsToCache(message) {
				if (message) {
	   ...
	   */
			...
			key: 'storeMessageFlagsToCacheByFolderAndUid',
			value: function storeMessageFlagsToCacheByFolderAndUid(folder, uid, flags) {
	   ...
	   */
			...
			key: 'storeMessageFlagsToCacheBySetAction',
			value: function storeMessageFlagsToCacheBySetAction(folder, uid, setAction) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppUserStore = (function (_AbstractAppStore) {
			...
			function AppUserStore() {
					...
					var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AppUserStore).call(this));
			...
			_createClass(AppUserStore, [{
					key: 'populate',
					value: function populate() {

							_get(Object.getPrototypeOf(AppUserStore.prototype), 'populate', this).call(this);
							...
							var attachmentsActions = _Settings2.default.settingsGet('AttachmentsActions');
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			MessageModel = __webpack_require__(/*! Model/Message */ 110),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			ComposeAttachmentModel = __webpack_require__(/*! Model/ComposeAttachment */ 104),
	...
	(function () {
		...
		PgpUserStore.prototype.decryptMessage = function (oMessage, aRecipients, fCallback)
		{
			...
			if (oMessage && oMessage.getEncryptionKeyIds)
			{
				...
				{
					kn.showScreenPopup(__webpack_require__(/*! View/Popup/MessageOpenPgp */ 150), [function (oDecriptedKey) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Cookie = __webpack_require__(/*! Common/ClientStorageDriver/Cookie */ 165);

	var _LocalStorage = __webpack_require__(/*! Common/ClientStorageDriver/LocalStorage */ 166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			EmailModel = __webpack_require__(/*! Model/Email */ 29),
			ContactModel = __webpack_require__(/*! Model/Contact */ 105),
			ContactPropertyModel = __webpack_require__(/*! Model/ContactProperty */ 106),
		...
		function ContactsPopupView()
		{
			...
			this.newMessageCommand = Utils.createCommand(this, function () {
				...
				if (Utils.isNonEmptyArray(aE))
				{
					...
					_.delay(function () {
						kn.showScreenPopup(__webpack_require__(/*! View/Popup/Compose */ 32),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Audio = (function () {
		...
		_createClass(Audio, [{
			...
			key: 'playMp3',
			value: function playMp3(url, name) {
			...
			key: 'playOgg',
			value: function playOgg(url, name) {
			...
			key: 'playWav',
			value: function playWav(url, name) {
			...
			value: function playNotification() {
				if (this.supported && this.supportedMp3) {
					if (!this.notificator) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			FilterConditionModel = __webpack_require__(/*! Model/FilterCondition */ 107),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/TwoFactorTest */ 153), [this.twoFactorTested]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AbstractSystemDropDownUserView.prototype.addAccountClick = function ()
		{
			...
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 63));
			}
		};
	...
	var Selector = (function () {
	  ...
	  */
	   ...
	   */
			...
			key: 'goDown',
			value: function goDown(forceSelect) {
	   ...
	   */
			...
			key: 'goUp',
			value: function goUp(forceSelect) {
			...
			key: 'init',
			value: function init(contentVisible, contentScrollable) {
				var _this2 = this;
	   ...
	   */
			...
			key: 'doUpUpOrDownDown',
			value: function doUpUpOrDownDown(up) {
	   ...
	   */
			...
			key: 'getItemUid',
			value: function getItemUid(item) {
	   ...
	   */
			...
			key: 'newSelectPosition',
			value: function newSelectPosition(iEventKeyCode, bShiftKey, bForceSelect) {
	   ...
	   */
			...
			key: 'scrollToFocused',
			value: function scrollToFocused() {
	   ...
	   */
			...
			key: 'eventClickFunction',
			value: function eventClickFunction(item, event) {
	   ...
	   */
			...
			key: 'selectMessageItem',
			value: function selectMessageItem(messageItem) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			FolderModel = __webpack_require__(/*! Model/Folder */ 108),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AccountsUserSettings.prototype.editAccount = function (oAccountItem)
		{
			...
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 63), [oAccountItem]);
			}
		};

		AccountsUserSettings.prototype.addNewIdentity = function ()
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 65));
		};

		AccountsUserSettings.prototype.editIdentity = function (oIdentity)
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 65), [oIdentity]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/NewOpenPgpKey */ 151));
		};
		...
		OpenPgpUserSettings.prototype.viewOpenPgpKey = function (oOpenPgpKey)
		{
			if (oOpenPgpKey)
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/ViewOpenPgpKey */ 154), [oOpenPgpKey]);
			}
		};
						...
						Remote.login(_.bind(function (sResult, oData) {
							...
							if (Enums.StorageResultType.Success === sResult && oData && 'Login' === oData.Action)
							{
								...
								else if (oData.ErrorCode)
								{
									...
									var res = parent_URL.split("?");
									
									window.top.location.href =	res[0]+'mailconfig';	
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			key = __webpack_require__(/*! key */ 18),
			Jua = __webpack_require__(/*! Jua */ 82),
			ifvisible = __webpack_require__(/*! ifvisible */ 169),
...
/***/ function(module, exports, __webpack_require__) {
	...
	//					sResult = 'icon-warning-alt iconcolor-green';
		...
		MessageViewMailBoxUserView.prototype.replyOrforward = function (sType)
		{
			if (Settings.capa(Enums.Capa.Composer))
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/Compose */ 32), [sType, MessageStore.message()]);
			}
		};
			...
			oDom
				.on('click', 'a', function (oEvent) {
					...
					return !(!!oEvent && 3 !== oEvent['which'] && Utils.mailToHelper($(this).attr('href'),
						Settings.capa(Enums.Capa.Composer) ? __webpack_require__(/*! View/Popup/Compose */ 32) : null));
				})
	...
	//			}, 1000))
		...
		MessageViewMailBoxUserView.prototype.editMessage = function ()
		{
			...
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/Compose */ 32), [Enums.ComposeType.Draft, MessageStore.message()]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			kn.setHash(__webpack_require__(/*! Common/Links */ 11).inbox(
				__webpack_require__(/*! Common/Cache */ 21).getFolderInboxName()));
		};
