	...
	?>
		<div class="row">
		  <div class="col-xs-12 col-sm-6 col-md-8">
			<div class=""><label><?php echo lang('EST_PREVIEW_DATE');?></label> </div>
			<div class=""><label><?php echo lang('EST_PREVIEW_LOCATION'); ?></label></div>
		  </div>
		  <div class="col-xs-12 col-sm-6 col-md-4">
			<?php if (isset($editRecord[0]['signature_date']) && $editRecord[0]['signature_date'] != null) { ?>
			<div class=""><label><?php echo lang('EST_PREVIEW_DATE'); ?></label> 
			...
			<?php } ?>
			<div class="">
					<label><?php echo lang('EST_PREVIEW_LOCATION'); ?></label> 
		...
		<div class="clr"></div>
		  <div class="col-xs-12 col-sm-6 col-md-8">
			<div class=""><label><?php echo lang('EST_LISTING_LABEL_NAME'); ?> :</label> </div>
		  </div>
		  <div class="col-xs-12 col-sm-6 col-md-4">
				<div class=""><label><?php echo lang('EST_LISTING_LABEL_NAME'); ?> :</label> 
		  ...
		  <div class="col-xs-12 col-sm-6 col-md-8">
			<div class="form-group"><label><?php echo lang('EST_PREVIEW_JOB_ROLE'); ?> :</label> </div>
		  </div>
		  <div class="col-xs-12 col-sm-6 col-md-4">
				<div class="form-group"><label><?php echo lang('EST_PREVIEW_JOB_ROLE'); ?> :</label> 
