    ...
    <div class="col-xs-12 col-md-12">
        <div class="row">
            <div class="col-xs-12 col-md-6 col-sm-6">
                <h3 class="white-link"> <?= lang('knowledge_article') ?></h3>
            </div>
            <div class="text-right col-md-6 col-sm-6">
                <?PHP if (checkPermission('KnowledgeBase', 'add')) { ?>
                    <a data-href="<?php echo base_url('Support/KnowledgeBase/AddArticle'); ?>" data-toggle="ajaxModal" class="btn btn-white" aria-hidden="true" data-refresh="true">
        ...
        <div class="whitebox" id="common_div">
            <?= $this->load->view('Support/KnowledgeBase/ajax_list_article.php', '', true); ?>
            <div class="clr"></div>
        </div>
        <div class="clr"></div>
    </div>
