<div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        <div class="row">
            ...
            <div class="text-right col-md-6">
                <?PHP if (checkPermission('KnowledgeBase', 'add')) { ?>
                    <a data-href="<?php echo base_url('Support/KnowledgeBase/AddSubCategory'); ?>" data-toggle="ajaxModal" class="btn btn-white" aria-hidden="true" data-refresh="true">
        ...
        <div class="whitebox" id="common_div">
            <?= $this->load->view('Support/KnowledgeBase/ajax_list_sub_category.php', '', true); ?>
            <div class="clr"></div>
        </div>
        <div class="clr"></div>
    </div>
