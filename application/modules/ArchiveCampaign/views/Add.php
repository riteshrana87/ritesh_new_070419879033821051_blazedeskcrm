        ...
        <form role="form" name="frm_createcampaign" id="frm_createcampaign" enctype="multipart/form-data" action="<?php echo base_url($path);?>" method="post" data-parsley-validate>
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><div class="modelTitle"><?php echo $modal_title;?></div></h4>
                </div>
                ...
                <div class="pad-10">
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6 col-sm-6 no-left-pad">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-3 col-md-3 col-lg-3 col-sm-3 no-left-pad form-group">
                                <div class="btn-group btn-toggle">
                                    <input data-toggle="toggle" data-onstyle="success" type="checkbox"  id="budget_requirement" name="budget_requirement" onChange="toggle_show_requirement(<?php echo "'#".$edit_time_id."'";?>, this)" <?=!empty($editRecord[0]['budget_requirement'])?'checked="checked"':''?>/>

                                </div>
                            </div>
                            <div class="col-xs-9 col-md-9 col-lg-9 col-sm-9 no-right-pad bd-form-group">
                                <label><?=$this->lang->line('BUDGET_REQUIRED')?><label>
                            </div>
                            <div class="clr"> </div>
                            <div class="col-lg-12 col-sm-12 col-md-12 colxs-12"><input name="budget_ammount" class="form-control" id="<?php echo $edit_time_id;?>" maxlength="20" value="<?=!empty($editRecord[0]['budget_ammount'])?$editRecord[0]['budget_ammount']:''?>"  placeholder="<?=$this->lang->line('BUDGET_AMOUNT')?>" pattern="/^\d{0,8}(\.\d{0,2})?$/" data-parsley-pattern="/^\d{0,8}(\.\d{0,2})?$/" /></div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6 col-lg-6 col-sm-6 no-right-pad">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-3 col-md-3 col-lg-3 col-sm-3 no-left-pad form-group">
                                <div class="btn-group btn-toggle">
                                    <input data-toggle="toggle" data-onstyle="success" type="checkbox"  id="revenue_goal" name="revenue_goal" onChange="toggle_show_requirement(<?php echo "'#".$revenue_time_id."'";?>, this)" <?=!empty($editRecord[0]['revenue_goal'])?'checked="checked"':''?>/>
                                </div>
                            </div>
                            <div class="col-xs-9 col-md-9 col-lg-9 col-sm-9 no-right-pad bd-form-group">
                            ...
                            <div class="clr"> </div>
                           <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12"> <input name="revenue_amount" class="form-control" id="<?php echo $revenue_time_id;?>" maxlength="20" value="<?=!empty($editRecord[0]['revenue_amount'])?$editRecord[0]['revenue_amount']:''?>" placeholder="<?=$this->lang->line('REVENUE_AMOUNT')?>" pattern="/^\d{0,8}(\.\d{0,2})?$/" data-parsley-pattern="/^\d{0,8}(\.\d{0,2})?$/"/></div>
                    </div>
                    </div>
                    <div class="clr"> </div>
                    <div class="col-xs-12 col-md-6 col-lg-6 col-sm-6 no-left-pad">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-3 col-md-3 col-lg-3 col-sm-3 no-left-pad form-group" >
                                <div class="btn-group btn-toggle ">
                                    <input data-toggle="toggle" data-onstyle="success" type="checkbox"  id="campaign_supplier" name="campaign_supplier" onChange="toggle_show(<?php echo "'#".$campaign_time_id."'";?>, this)" <?=!empty($editRecord[0]['campaign_supplier'])?'checked="checked"':''?> />
                            ...
                            <div class="clr"> </div>
                            <div id="<?php echo $campaign_time_id;?>">
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6 col-sm-6 no-right-pad">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-3 col-md-3 col-lg-3 col-sm-3 no-left-pad form-group">
                                <div class="btn-group btn-toggle">
                                    <input data-toggle="toggle" data-onstyle="success" type="checkbox"  id="related_product" name="related_product" onChange="toggle_show(<?php echo "'#".$related_time_id."'";?>, this)" <?=!empty($editRecord[0]['related_product'])?'checked="checked"':''?>/>
...
<div id="<?php echo $related_time_id;?>">
                           <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12"> <select class="chosen-select form-control related_product" data-placeholder="<?=$this->lang->line('EST_LBL_SELECT_PRODUCT')?>" multiple="true"  name="product_id[]" id="">
                ...
                <div class="modal-footer">
                    <div class="text-center">
                        <?php if(!empty($editRecord)){?>
                            <input type="submit" class="btn btn-primary" id="camp_submit_btn" value="<?=$this->lang->line('edit_archive_campaign')?>">
                        <?php }else{?>
