...
$path = $account_view . '/importAccountdata';
?>
<div class="modal-dialog modal-lg">
    <?php
    $attributes = array("name" => "import_account", "id" => "import_account", 'data-parsley-validate' => "");
        ...
        <div class="modal-body">
            <div class="form-group row">
                <div class="col-sm-6 col-lg-12 form-group">
                    <label class="custom-upload btn btn-blue"><?= $this->lang->line('import_account') ?> 
                ...
                <div class="col-sm-6 col-lg-12">
                    <a class="btn btn-green" downlaod target="_blank" href="<?php echo base_url() . "uploads/csv_account/SAMPLE_CSV_CLIENT.xlsx"; ?>"><span class="glyphicon glyphicon-cloud-download"></span>
                ...
                <div class="col-lg-12"><h4 class="mar_tp0"><code class="colo"><?php echo lang('UPLOAD_NOTE_IMPORTANT'); ?></code></h4>
                    <div class="col-lg-12">
                        <ul class="bd-gen-list">
                            ...
                            <li><span class="colo"><?php echo lang('UPLOAD_ACCOUNT_NAME_MUST_BE_EXISTED'); ?></span></li>
