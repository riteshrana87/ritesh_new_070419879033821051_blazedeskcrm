    ...
    <div class="table table-responsive">
        <table class="table table-responsive" >
            <thead>
                <tr role="row">
                    <th class='sortTask'>
                        <a    href="<?php echo base_url(); ?>Account/viewAllDealsData/?orderField=prospect_name&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Account/viewAllDealsData/?orderField=prospect_auto_id&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Account/viewAllDealsData/?orderField=contact_count&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Account/viewAllDealsData/?orderField=contact_name&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Account/viewAllDealsData/?orderField=creation_date&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
...
<script>
    function delete_request(prospect_id, redirect_link)
    {
        ...
        var delete_meg = "<?php echo lang('CONFIRM_DELETE_DEALS'); ?>";
    ...
    {
        var delete_meg = "<?php echo lang('CONFIRM_CONVERT_CONVERTWIN'); ?>";
        BootstrapDialog.show(
                {
                    title: '<?php echo $this->lang->line('Information'); ?>',
                    message: delete_meg,
    ...
    {
        var delete_meg = "<?php echo lang('CONFIRM_CONVERT_CONVERTLOST'); ?>";
        BootstrapDialog.show(
                {
                    title: '<?php echo $this->lang->line('Information'); ?>',
                    message: delete_meg,
