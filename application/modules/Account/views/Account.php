...
<div class="row">
    ...
    <!-- Search: Start -->
    <div class="col-xs-12 col-md-3 col-sm-6 col-lg-3 pull-right text-right col-md-offset-3">
        <div class="row">
    ...
    <div class="col-xs-12 col-md-9 col-lg-9 col-sm-12">
        ...
        <?php } ?>
        <div class="row"> <div class="col-xs-12 col-md-4 col-sm-3 no-left-pad"><h3 class="white-link"><?= lang('manage_account') ?></h3></div>
            <div class="col-xs-12 col-md-8 col-sm-9 no-left-pad text-right">      
                <?PHP //if (checkPermission('Account', 'add')) { ?>
                            <!--<a data-href="<?php echo base_url($account_view . '/add'); ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" class="btn btn-white add_account"><?= $this->lang->line('create_new_client') ?></a>-->
                <?php //} ?>
                <?PHP if (checkPermission('Account', 'view')) { ?><a href="<?php echo base_url($account_view . '/lostClient'); ?>" class="btn btn-white add_account"><?= $this->lang->line('LOST_CLIENT') ?></a><?php } ?>
                <?php if (checkPermission('Account', 'add')) { ?><a data-href="<?php echo base_url($account_view . '/importAccount'); ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?= lang('import_account') ?>" class="btn btn-white" ><?= $this->lang->line('import_account') ?></a><?php } ?>
                <?php if (checkPermission('Account', 'add')) { ?><a title="<?= lang('EXPORT_ACCOUNTS') ?>" class="btn btn-white" onclick="exportAccount();"><?= $this->lang->line('EXPORT_ACCOUNTS') ?></a><?php } ?>
            </div>
            <div class="clr"></div></div>
        <div class="whitebox" id="common_div">
            <?= $this->load->view('AjaxAccountList', '', true); ?>
        </div>
    </div>
    <div class="col-md-12 col-md-3 col-lg-3 col-sm-12 col-xs-12">
        <div class=" whitebox">
            <div class="col-md-6 col-xs-6"> <span class="font-3em greencol"><b id="totalAccountText"><?php echo $total_account; ?></b></span> </div>
            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="col-md-5 col-xs-5 no-left-pad">
                    <div class="form-group">
                        <input type="text" class="form-control" name="start_value" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46 || event.charCode == 0" id='start_value' value="<?php
                ...
                <div class="col-md-5 col-xs-5 no-right-pad">
                    <div class="form-group">
                        <input type="text" class="form-control" name="end_value" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46 || event.charCode == 0" id='end_value' value="<?php
                ...
                <div class="col-md-6 col-xs-6 no-left-pad">
                    <div class="form-group">
                        <div class='input-group date' id="search_contact_date">
                            <input type="text" class="form-control searchAjax search_contact_date" placeholder="<?= lang('start_date'); ?>" id="search_contact_date" name="search_contact_date" value="<?php
                ...
                <div class="col-md-6 col-xs-6 no-right-pad">
                    <div class="form-group">
                        <div class='input-group date' id="contact_end_date">
                            <input type="text" class="form-control searchAjax contact_end_date" placeholder="<?= lang('END_DATE'); ?>" id="contact_end_date" name="contact_end_date" value="<?php
...
<div class="row">
    ...
    <?php } ?>
    <div class="col-md-2 col-new-71 col-xs-12 lang-widthauto"> <a class="btn btn-white full-width" href="<?php echo base_url('Account'); ?>"><?php echo $this->lang->line('manage_clients') ?></a> </div>
...
//        })	   
    ...
    {
        var export_url = '<?php echo base_url() . "Account/exportAccounts"; ?>';
