...
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <h4>Email : <?php
                echo $contact_record[0]['prospect_name'];
                ?></h4>
            ...
            <div class="row">  
               ...
               <div class="col-xs-12 col-md-6 no-left-pad">
                 <div class="form-group">
                     <select name="prospect_id" id="prospect_id" class="form-control chosen-select" onchange="autoFillProspectData(this.value);" required data-parsley-errors-container="#salution-errors">
                         <option value=""><?php echo lang('select_prospect_name'); ?></option>
                <?php
                foreach ($prospect_data as $prospect) {
                    ?>
                                     <option value="<?php echo $prospect['prospect_id']; ?>"><?php echo $prospect['prospect_name'] . "&nbsp;-&nbsp;&nbsp;(" . $prospect['prospect_auto_id'] . ")"; ?></option>
                <?php }
                ?>
                     </select>
             ...
             <div class="col-xs-12 col-md-6 no-right-pad">
                 <div class="form-group">
                     <input type="text" name="prospect_auto_id" id="prospect_auto_id" class="form-control"  placeholder="Prospect Id" disabled="true"/>
                 </div>
             </div>-->
                <div class="clr"></div>
            </div>
...
foreach ($company_data as $company) {
    ?>
                ...
                <div class="col-xs-12 no-right-pad">
                    <div class="form-group">
                        <select name="prospect_owner" id="prospect_owner" class="form-control chosen-select" disabled="true" data-parsley-errors-container="#prospect_owner_error">
...
<?php } ?>
            ...
            <div class="row"> <div class="col-xs-12 col-md-6 no-left-pad">
                    <div class="form-group">
                        <select multiple="" name="company_contact[]" data-placeholder="<?php echo lang('SELECT_PROSPECT_CONTACT'); ?>"  id="company_contact" class="form-control chosen-select" data-parsley-errors-container="#company_errors">
                            ...
                            <?php
                            if (count($prospect_receipent_array) > 0) {
                                foreach ($prospect_receipent_array as $prospect_receipent) {
                                    ?>
                                    <option value="<?php echo $prospect_receipent['contact_id'] ?>"> <?php echo $prospect_receipent['contact_name'] ?></option>
                                <?php }
                            }
                            ?>
                ...
                <div class="col-xs-12 col-md-6 no-right-pad">
                    <div class="form-group">
                        <select name="cc_employee" id="cc_employee" placeholder="CC Employee" class="form-control chosen-select">
                            <option value=""><?php echo lang('CC_EMPLOYEE'); ?></option>
                            <?php
            ...
            <div class="row"><div class="col-xs-12 col-md-5 col-lg-5 no-left-pad">
                    <div class="form-group">
                        <input type="text" name="email_subject" id="email_subject" class="form-control" placeholder="<?php echo lang('subject'); ?> *" required=""/>
                    </div> 

                </div>
                <div class="col-lg-2 col-md-2 text-center bd-form-group">
                    <label>or</label>
                </div>
...
?>
            ...
            <div class="row"><div class="col-xs-12 col-md-12 no-left-pad">
                    <div class="form-group">
                        <textarea class="form-control" name="email_content" id="email_content" data-parsley-errors-container="#content_errors"></textarea>
                        <div id="content_errors"></div>
                    </div>
            ...
            <div class="col-xs-6 col-md-5">
                <div class="form-group">
                    <input type="file" class="form-control" name="mail_attachment[]" id="mail_attachment" multiple="true"/>
                </div> 
                <div class="clr"> </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 no-right-pad col-lg-3 mb15">
                ...
                <div class="col-xs-12 col-md-4 no-right-pad col-lg-5">
            ...
            <input type="hidden" name="hdn_contact_id" id="hdn_contact_id" value="<?php if (isset($contact_id) && $contact_id != '')
                {
                    echo $contact_id;
                } ?>"/>
            <input type="hidden" name="hdn_company_email" id="hdn_company_email" value="<?php if (isset($company_email) && $company_email != '')
                {
                    echo $company_email;
                } ?>"/>
...
<script type="text/javascript">
    ...
    function autoFillProspectData(prospect_id)
    {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() . "Contact/getProspectDataById" ?>',
            ...
            success: function (data)
            {
                ...
                $("#hdn_contact_id").val(splitData[1]);
            }
        });
    }
...
//            console.log(fileext);
            ...
            xhr[rand].upload.addEventListener("progress", function (event) {
                ...
                if (event.lengthComputable) {
                    ...
                    var delete_meg = "<?php echo lang('failed_compute_file'); ?>";
                    BootstrapDialog.show(
                            {
                                title: '<?php echo $this->lang->line('Information'); ?>',
                                message: delete_meg,
