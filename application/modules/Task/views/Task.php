    ...
    <div class="col-sm-9">
        <div class="col-xs-12 col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <?PHP if (checkPermission('Task', 'add')) { ?><a data-href="<?php echo base_url('Task/add'); ?>" class="btn btn-default pull-right" data-toggle="ajaxModal" aria-hidden="true" data-refresh="true">+<?php echo lang('create'); ?></a><?php } ?>
                </div>
                            ...
                            <?php if (isset($task_data) && count($task_data) > 0) { ?>
                                <?php foreach ($task_data as $task_data) { ?>
                                    <tr>
                                        ...
                                        <td> <?PHP if (checkPermission('Task', 'edit')) { ?><a data-href="<?php echo base_url('Task/edittask/' . $task_data['task_id'] . '/SalesOverview'); ?>" data-toggle="ajaxModal" aria-hidden="true" data-refresh="true" class="edit_lead" id="edit_lead"><i class="fa fa-pencil fa-x bluecol"></i></a><?php } ?>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <?PHP if (checkPermission('Task', 'view')) { ?><a data-href="<?php echo base_url('Task/viewtask/' . $task_data['task_id'] . '/SalesOverview'); ?>" data-toggle="ajaxModal" aria-hidden="true" data-refresh="true" class="view_lead" id="view_lead"><i class="fa fa-search fa-x greencol"></i></a><?php } ?>    
                                        </td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
