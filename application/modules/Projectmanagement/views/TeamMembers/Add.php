...
<?php if (!isset($editTeam)) { ?>
    <div class="modal-dialog"  id="teamReplacer">
        <?php
        if (isset($id)) {
            $validateUrl = base_url('Projectmanagement/TeamMembers/teamNameValidate/' . $id);
        } else {
            $validateUrl = base_url('Projectmanagement/TeamMembers/teamNameValidate/0');
        }
        ?>
    ...
    <!--                                data-parsley-remote="<?php echo $validateUrl; ?>"  data-parsley-trim-value="true"
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                            <div class="form-group">
                                <select tabindex="-1" id="team_lead_id"  name="team_lead_id" class="chosen-select"  required>
                    ...
                    <div class = "teamLeader">
                        <?php if (isset($teamLeader) && !empty($teamLeader)) {
                            ...
                            <div class="row" id='team_member<?php echo $teamLeader[0]['member_id']; ?>'>
                                ...
                                <div class="bd-error-control">
                                    <div class="bd-error pad-tb15">
                        ...
                        if (isset($teamData) && !empty($teamData)) {
                            foreach ($teamData as $team) {
                                ...
                                <div class="row"  id='team_member<?php echo $team['member_id']; ?>'>
                                    ...
                                    <div class="col-xs-7 col-md-4 pad-tb20">
                                    ...
                                    <div class="bd-error-control">
                                        <div class="bd-error pad-tb15">
                                            ...
                                            <a href='javascript:;' title="<?php echo lang('delete'); ?>" class='removeTeamMembers' data-id='team_member<?php echo $team['member_id']; ?>'><i class='fa fa-remove redcol'></i></a>
                                        </div>
                                    </div>
                                    <div class="clr"></div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12 pad-tb12">
                            <input type="text" style="display:none" class="team_member_cnt" data-parsley-required-message="<?php echo lang('select_member'); ?>"  name="team_member_cnt" id="team_member_cnt" required />
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-5 bd-togl-label">
                            <div class="form-group">
                                <div class="pull-left"><input  data-toggle="toggle" data-onstyle="success" type="checkbox" id="notify_members" name="notify_members" value="1" data-on="<?php echo lang('on'); ?>" data-off="<?php echo lang('off'); ?>"></div>
                        ...
                        <div class="col-xs-12 col-md-4 text-left">
                            <div class="form-group">
                                <a class="btn btn-green" href="javascript:;"  onClick="$('#schedule_meeting').toggleClass('hidden', 'show');"><i class="fa fa-clock-o"></i><?php echo lang('schedule_meeting'); ?></a>
            ...
            <form id="from-model" method="post" enctype="multipart/form-data" action="<?php echo base_url($formPath); ?>" data-parsley-validate>
                ...
                <div class="modal-body">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
                                <select tabindex="-1" data-parsley-errors-container="#team-errors"  <?php echo (isset($editTeam)) ? 'required' : ''; ?> id="team_id" onchange="displayTeamById(this.value,<?php echo (isset($editTeam)) ? 1 : 0; ?>);"  name="team_id" class="chosen-select" data-placeholder="<?php echo lang('select_team_template'); ?> *" >
                                    <option value=""><?php echo lang('select_team_template'); ?> *</option>
                                    <?php
                                    if (!empty($team_list)) {
                                        foreach ($team_list as $row) {
                                            ?>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                            <div class="form-group">
                                <select tabindex="-1" id="team_lead_id"  name="team_lead_id" class="chosen-select" data-placeholder="Choose a Task *" required>
                                    <option value=""><?php echo lang('select_team_leader'); ?> *</option>
                                    <?php
                                    if (!empty($team_leader)) {
                                        foreach ($team_leader as $row) {
        ...
        <!--                                    <input type='hidden' name='team_members[]' value="<?php echo $teamLeader[0]['member_id']; ?>">-->
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-5 bd-togl-label">
                            <div class="form-group">
                                <div class="pad_top20">
                                    <input <?php if (!empty($edit_record[0]['remember'])) { ?>checked="checked"<?php } ?> data-toggle="toggle" data-onstyle="success" type="checkbox"  id="reminder" name="reminder" onChange="$('#reminderBox').toggleClass('hidden', 'show');" data-on="<?php echo lang('on'); ?>" data-off="<?php echo lang('off'); ?>"/>
                                    <label>
                                        <?= $this->lang->line('reminder?') ?>
                                    </label>
                                </div>
