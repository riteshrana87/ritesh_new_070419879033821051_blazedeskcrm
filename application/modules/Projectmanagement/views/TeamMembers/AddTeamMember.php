            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-12 pad-tb12">
                        <!--                        <div class="text-center font-15em"><u><b>Add Team Members</b></u></div>-->
                    </div>
                </div>
                <div class="clr"></div>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6 bd-togl-label">
                        <div class="form-group">
                            <div class="pull-left"><input  data-toggle="toggle" data-onstyle="success" type="checkbox" id="notify_tl" name="notify_tl" value="1" data-on="<?php echo lang('on'); ?>" data-off="<?php echo lang('off'); ?>"></div>
