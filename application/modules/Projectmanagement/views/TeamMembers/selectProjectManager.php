        ...
        <form id="from-model" method="post" enctype="multipart/form-data" action="<?php echo base_url($formPath); ?>" data-parsley-validate>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <div class="form-group">
                            <select tabindex="-1" id="project_manager_id"  name="project_manager_id" class="chosen-select" required>
            ...
            <div class="modal-footer">
                <div class="text-center">
                    <input type="submit" class="btn btn btn-primary" name="submit_btn" id="submit_btn" value="<?php echo lang('assign_pm'); ?>" />
