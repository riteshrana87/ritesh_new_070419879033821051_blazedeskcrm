...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form id="add_company" name="add_company" method="post"  action="<?php echo base_url($path); ?>" data-parsley-validate="" enctype="multipart/form-data"> 
            <div class="modal-body">
                ...
                <div class=" row">
                    ...
                    <div class="col-sm-6 form-group">
                        <input class="form-control" name="company_name" id="company_name" tabindex="2" placeholder="<?= lang('company_name') ?> *" type="text" value="<?PHP
                ...
                <div class=" row">
                    <div class="col-sm-6 form-group">
                        ...
                        <input type="text" id="branch_id" name="branch_id" class="form-control" tabindex="3" placeholder="<?= $this->lang->line('branche') ?> *" value="<?php
                    ...
                    <div class="col-sm-6 form-group">
                        <input class="form-control" name="phone_no" placeholder="<?= lang('contact_no') ?>" tabindex="4" type="text" value="<?PHP
                               if ($formAction == "insertdata") {
                ...
                <div class=" row">
                    <div class="col-sm-6 form-group">
                        <input class="form-control" name="website" placeholder="<?= lang('website') ?>" tabindex="5" type="url" value="<?PHP
                               if ($formAction == "insertdata") {
                    ...
                    <div class="col-sm-6 form-group">
                        <input class="form-control" name="address1" id="address1" tabindex="6" placeholder="<?= lang('address1') ?>" type="text" value="<?PHP
                               if ($formAction == "insertdata") {
                ...
                <div class=" row">
                    <div class="col-sm-6 form-group">
                        <input class="form-control" name="address2" placeholder="<?= lang('address2') ?>" tabindex="7" type="text" value="<?PHP
                               if ($formAction == "insertdata") {
                    ...
                    <div class="col-sm-6 form-group">
                        <input class="form-control" name="city" id="city" placeholder="<?= lang('city') ?>" tabindex="8" type="text" value="<?PHP
                        if ($formAction == "insertdata") {
                            echo set_value('city');
                ...
                <div class="row">
                    <div class="col-sm-6 form-group ">
                        <input class="form-control" name="state" placeholder="<?= lang('state') ?>" tabindex="9" type="text" value="<?PHP
                        if ($formAction == "insertdata") {
                    ...
                    <div class="col-sm-6 form-group ">
                        <input class="form-control" name="email_id" placeholder="<?= lang('email') ?> *" tabindex="10"  type="email" value="<?PHP
                        if ($formAction == "insertdata") {
                        ...
                        <ul class='parsley-errors-list filled hidden' id='email_err'><li class='parsley-remote'><?php echo lang('email_exist'); ?></li></ul>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 form-group ">
                        <input class="form-control" name="postal_code" id="postal_code" placeholder="<?= lang('postal_code') ?>" tabindex="11" type="text" value="<?PHP
                            if ($formAction == "insertdata") {
                                echo set_value('postal_code');
                                ?><?php } else { ?><?= !empty($editRecord[0]['postal_code']) ? $editRecord[0]['postal_code'] : '' ?><?php } ?>"  />
                    </div>
                    <div class="col-sm-6 form-group">
                        <select name="status" class="form-control chosen-select" id="status" tabindex="12">
...
<?php } ?>
    ...
    function validateCompanyUniqueness(email)
    {
        $('.email_contact').each(function () {
            if ("email_id" != $(this).attr('id'))
            {
                if (email == $(this).val())
                {
                    $(this).val('');
        ...
        if (email != '')
        {
            ...
            $.ajax({
                url: "<?php echo base_url('CrmCompany/validateCompanyUniqueness'); ?>",
