...
<div class="row">
    <div class="col-md-6 col-lg-6 col-sm-6">
        <ul class="breadcrumb nobreadcrumb-bg">
            ...
            <li><a href="<?php echo base_url() . 'Lead'; ?>"><?= lang('leads') ?></a></li>
                            ...
                            <ul class="contact-list1">
                                ...
                                <?php if (isset($all_records[0]['phone_no']) && $all_records[0]['phone_no'] != "") { ?>
                                    ...
                                    <li> <i class="fa fa-envelope bluecol"></i>&nbsp;&nbsp;&nbsp;<?php if (!empty($all_records[0]['company_email']) && $all_records[0]['company_email'] != "") {
                                        ...
                                        <?php if (!empty($all_records[0]['email_id']) && $all_records[0]['email_id'] != "") { ?>
...
<?php } ?>
                        ...
                        <div class="col-xs-8"><ul class="contact-list2">
                                <?php if (isset($all_records[0]['company_name']) && $all_records[0]['company_name'] != "") { ?>
                                    <li><?php echo htmlentities(stripslashes($all_records[0]['company_name'])); ?></li>
                                <?php } ?>
...
<?php } ?>
                ...
                <div class="col-xs-12 col-md-3">
                    <div class="col-xs-12  no-right-pad">
                        <div class="text-right" id="contact_address"></div>
...
<?php if (checkPermission('Lead', 'add')) { ?>
                            <a class="btn btn-blue" data-href="<?php echo base_url() . "Lead/send_email_view/" . $all_records[0]['lead_id']; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('SEND_EMAIL'); ?>"><i class="fa fa-envelope"></i>&nbsp;&nbsp;<span><?php echo lang('SEND_EMAIL'); ?></span></a>&nbsp;&nbsp;&nbsp;
<?php } ?>
<?php if (checkPermission('Lead', 'add')) { ?>
                            <a class="btn btn-blue" data-href="<?php echo base_url() . "Contact/scheduleMeeting/" . $all_records[0]['lead_id']; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('SCHEDULE_MEETING'); ?>"><i class="fa fa-calendar"></i>&nbsp;&nbsp;<span><?php echo lang('SCHEDULE_MEETING'); ?></span></a>&nbsp;&nbsp;&nbsp;
<?php } ?>
<?php if (checkPermission('Lead', 'view')) { ?>
                            <a class="btn btn-blue" id ="navigate_contact" data-href="<?php echo base_url() . "Lead/navigation/" . $all_records[0]['lead_id']; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('NAVIGATE_CONTACT'); ?>"><i class="fa fa-map-marker"></i><span>&nbsp;&nbsp;<?php echo lang('NAVIGATE_CONTACT'); ?></span></a>&nbsp;&nbsp;&nbsp;
<?php } ?>
                    </div>
                    <div class="clr"></div>
                </div>
            ...
            <form>
                <div class="form-group">
                    <select class="form-control">
                        <option><?= lang('select_lead_owner') ?></option>
...
<?php } ?>
                ...
                <div class="pad-tb6">
                <?php if (checkPermission('Lead', 'edit')) { ?><a data-href="<?php echo base_url($lead_view . '/editdata/' . $all_records[0]['lead_id']); ?>" data-toggle="ajaxModal"  aria-hidden="true" data-refresh="true" class="edit_lead" id="edit_lead"><i class="fa fa-pencil fa-x bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('edit') ?></a><?php } ?>
                </div>
                <div class="grayline-1"></div>
                <div>
<?php if (checkPermission('Contact', 'add')) { ?><a data-href="<?= base_url() ?>Contact/addNote/<?= $all_records[0]['lead_id']; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('ADD_NOTES'); ?>"><i class="fa fa-comment bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('ADD_NOTES'); ?></a><?php } ?>
                </div>
                <div>
                    <!--  //base_url() ?>Contact/viewTask/ //$all_records[0]['contact_id'] ?>-->
<?php if (checkPermission('Task', 'add')) { ?><a data-href="<?php echo base_url('Task/add') . "/" . $all_records[0]['lead_id']; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('ADD_TASKS'); ?>"><i class="fa fa-file-text bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('ADD_TASKS'); ?></a><?php } ?>
                </div>
                <div>
<?php if (checkPermission('Opportunity', 'add')) { ?><a data-href="<?= base_url() ?>Opportunity/add/<?= $all_records[0]['lead_id']; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('ADD_DEAL'); ?>"><i class="fa fa-tag bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('ADD_DEAL'); ?></a>
                    </div>
                    <div class="grayline-1"></div>
<?php }
?>
...
<?php if (checkPermission('Contact', 'add')) { ?>
                        <a data-href="<?php echo base_url() . 'Contact/view_add_campaign/' . $all_records[0]['lead_id']; ?>"  aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('ADD_TO_CAMPAIGN'); ?>"><i class="fa fa-sitemap bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('ADD_TO_CAMPAIGN'); ?> </a>
<?php } ?>
                ...
                <div class="pad-tb6">
<?php if (checkPermission('Contact', 'add')) { ?>
                        <a data-href="<?php echo base_url() . 'Contact/AddCases/' . $all_records[0]['lead_id']; ?>"  aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('add_cases'); ?>"><i class="fa fa-sitemap bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('add_cases'); ?> </a>
<?php } ?>
...
if (checkPermission('Lead', 'delete')) {
    ?>
                        <div>
                            <a onclick="delete_lead('<?php echo $all_records[0]['lead_id']; ?>', 'Lead');" title="<?php echo lang('CONTACT_DELETE'); ?>"><i class="fa fa-remove bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('CONTACT_DELETE'); ?> </a>
                        </div>
<?php } ?>
                </div>
...
if (checkPermission('Contact', 'add')) {
    ?>
                    <div class="pad-10 text-center">
                        <a data-href="<?= base_url() ?>Contact/viewLeadFile/<?= $all_records[0]['lead_id'] ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('ADD_FILE_TO_CONTACT'); ?>" class="width-100 btn small-white-btn2"><?php echo lang('ADD_FILE_TO_CONTACT'); ?></a>
                    </div>
<?php } ?>
                <div class="clr"></div>
            </form>
...
//not included in loadjsFiles bcoz there are to many validations are working as global
    ...
    function getContactData(searchtext)
    {
        ...
        $.ajax({
            type: "POST",
            url: url_contact,
            data: {'getContactData': 'Contacts', 'searchtext': searchtext, 'contact_related_id': '<?php echo $all_records[0]['lead_id']; ?>', 'contact_status': '3'},
    ...
    function getNoteData(searchtext)
    {
        ...
        $.ajax({
            type: "POST",
            url: url_contact,
            data: {'getNoteData': 'Note', 'searchtext': searchtext, 'note_related_id': '<?php echo $all_records[0]['lead_id']; ?>', 'note_status': '3'},
            success: function (data)
            {
                $('#Notes').html(data);
            }
    ...
    function getTasksData(searchtext)
    {
        ...
        $.ajax({
            type: "POST",
            url: url_contact,
            data: {'getTasksData': 'Tasks', 'searchtext': searchtext, 'task_related_id': '<?php echo $all_records[0]['lead_id']; ?>', 'task_status': '3'},
            success: function (data)
            {
                $('#Tasks').html(data);
            }
    ...
    function getDealsData(searchtext)
    {
        ...
        $.ajax({
            type: "POST",
            url: url_contact,
            data: {'getDealsData': 'Deals', 'searchtext': searchtext, 'deals_related_id': '<?php echo $all_records[0]['lead_id']; ?>', 'deal_status': '3'},
            success: function (data)
            {
                $('#Deals').html(data);
            }
    ...
    function getCampaignData(searchtext)
    {
        ...
        $.ajax({
            type: "POST",
            url: url_contact,
            data: {'getDealsData': 'Campaign', 'searchtext': searchtext, 'campaign_related_id': '<?php echo $all_records[0]['lead_id']; ?>', 'campaign_status': '3'},
            success: function (data)
            {
                $('#Campaign').html(data);
            }
    ...
    function getLeadFile(searchtext)
    {
        ...
        $.ajax({
            type: "POST",
            url: url_contact,
            data: {'getDealsData': 'Documents', 'searchtext': searchtext, 'file_related_id': '<?php echo $all_records[0]['lead_id']; ?>', 'file_status': '3'},
            success: function (data)
            {
                $('#Documents').html(data);
            }
    ...
    function getContactCases(searchtext)
    {
        ...
        $.ajax({
            type: "POST",
            url: url_contact,
            data: {'getDealsData': 'Campaign', 'searchtext': searchtext, 'cases_related_id': '<?php echo $all_records[0]['lead_id']; ?>', 'cases_status': '3'},
            success: function (data)
            {
                $('#Cases').html(data);
            }
    ...
    function getContactEvents(searchtext)
    {
        ...
        $.ajax({
            type: "POST",
            url: url_contact,
            data: {'getDealsData': 'Campaign', 'searchtext': searchtext, 'event_related_id': '<?php echo $all_records[0]['lead_id']; ?>', 'cases_status': '3'},
            success: function (data)
            {
                $('#Events').html(data);
            }
    ...
    function getContactMeeting(searchtext)
    {
        ...
        $.ajax({
            type: "POST",
            url: url_contact,
            data: {'getDealsData': 'Campaign', 'searchtext': searchtext, 'meeting_related_id': '<?php echo $all_records[0]['lead_id']; ?>', 'meet_status': '1'},
            success: function (data)
            {
                $('#Meeting').html(data);
            }
