...
<div class="modal-dialog ">
    ...
    <div class="modal-content">
        ...
        <div class="pad-10">
                ...
                <div class = "form-group row">
                    ...
                    <div class = "col-sm-6">
                       ...
                       */
                        ...
                        <?=!empty($editRecord[0]['campaign_auto_id'])?$editRecord[0]['campaign_auto_id']:$camping_auto_id?>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-md-12 no-left-pad">
                <div class = "form-group row">
                    <div class = "col-sm-6">
                        ...
                        <?=!empty($editRecord[0]['camp_type_name'])?$editRecord[0]['camp_type_name']:''?>
                            ...
                            if(count($responsible_user_data) > 0 && $responsible_user_data != "0") {
                                ...
                                foreach ($responsible_employee_data as $row) {
                                    if (in_array($row['login_id'], $responsible_user_data)) {
                                        ?>
                                        <?php $tmp_str .= $row['firstname'] . ' ' . $row['lastname'] . ','; ?>
                                    <?php }
                                }
                                echo rtrim($tmp_str, ',');
                            }else{
            ...
            <div class="col-xs-12 col-md-12 no-left-pad">
                <div class = "form-group row">
                    <div class = "col-sm-12 bd-rsp-image">
            ...
            <div class="col-xs-12 col-md-6 no-left-pad col-sm-6">
                <div class="form-group row">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12">
                        ...
                        <input name="budget_ammount" class="form-control" id="" maxlength="20" value="<?=!empty($editRecord[0]['budget_ammount'])?$editRecord[0]['budget_ammount']:'0'?>"  placeholder="<?=$this->lang->line('BUDGET_AMOUNT')?>" <?php echo $readonly?> />
                        <?php }else{
            ...
            <div class="col-xs-12 col-md-6 col-lg-6 no-right-pad col-sm-6">
                <div class="form-group row">
                    ...
                    <?php }else{
                        ...
                        echo $editRecord[0]['revenue_goal'];
                        }?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-md-6 no-right-pad col-sm-6">
                <div class="form-group row">
                    ...
                    <?php if(!empty($editRecord[0]['related_product'])){?>
                            ...
                            <?php if(!empty($product_data) && in_array($row['product_id'],$product_data)){$tmp .= $row['product_name'].',';} else { $blnkFlag++; } ?>
            ...
            <div class="col-xs-12 col-md-6 no-left-pad">
                <div class="form-group">
                    <label> <?=$this->lang->line('CAMPAIGN_GROUP')?>  :</label>
                    <?php
                ...
                <div class="clr"> </div>
                <div class="form-group">
                    <label> <?=$this->lang->line('CAMPAIGN_RECEIPIENTS')?>:</label>
                    <div class="clr"> </div>
                    <?php
                    if(count($EstRecipientArray) > 0 && $EstRecipientArray != "0") {
                        ...
                        foreach ($contact_info as $contact) { ?>
                            <?php if (in_array('contact_' . $contact['contact_id'], $EstRecipientArray)) { ?>
                                <?php $tmp_con .= $contact['contact_name'] . ','; ?>
                            <?php }
                        }
                        echo rtrim($tmp_con, ',');
                    }else{
