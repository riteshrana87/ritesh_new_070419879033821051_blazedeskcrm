...
<div class="row">
    <div class="col-md-6 col-sm-6">
        <ul class="breadcrumb nobreadcrumb-bg">
            ...
            <li class="active"><?= lang ('MY_MESSAGES') ?></li>
        </ul>
    </div>
    <!-- Search: Start -->
            ...
            <div class="col-xs-10 col-md-10 col-sm-10 text-right search-top pull-right">
                <form id="searchForm" class="navbar-form navbar-left pull-right">
                    ...
                    <span class="input-group-btn">
                        <button type="submit" id="submit" title="<?php echo lang('search');?>" name="submit" class="btn btn-default"><i
...
<div class="row">
    <div class="col-xs-6 col-md-6 no-left-pad">
        <h3 class="white-link"><?= lang ('MY_MESSAGES') ?></h3>
    </div>
...
<div class="whitebox" id="common_div">
    ...
    <?php $this->load->view ('MessageAjaxList') ?>
</div>
<div class="clr"></div>
