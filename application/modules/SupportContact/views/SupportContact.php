                ...
                <div class="navbar-form navbar-left pull-right" id="searchForm">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            ...
                            <button class="btn btn-default" title="Reset" title="<?php echo lang('reset');?>" onclick="reset_data()"><i class="fa fa-refresh fa-x"></i></button>
                        </span> </div>
                    <!-- /input-group -->
                </div>
            </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-6 col-sm-8 col-lg-6 pull-right text-right">
                <?php if (checkPermission('SupportContact', 'add')) { ?><a data-href="<?php echo base_url() . 'SupportContact/addrecord'; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?= lang('create') ?>" class="btn btn-white" ><?= $this->lang->line('create_new_contact') ?></a><?php } ?>&nbsp;&nbsp;
                <?php if (checkPermission('SupportContact', 'add')) { ?><a data-href="<?php echo base_url() . 'SupportContact/importContact'; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?= lang('import_contact') ?>" class="btn btn-white" ><?= $this->lang->line('import_contact') ?></a><?php } ?>
                <?php if (checkPermission('SupportContact', 'add')) { ?><a title="<?= lang('export_contact') ?>" class="btn btn-white" onclick="exportContact();"><?= $this->lang->line('export_contact') ?></a><?php } ?>
            </div>
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class='input-group date search_creation_date' >
                            <input type="text" class="form-control search_creation_date" placeholder="<?= lang('start_date'); ?>" id="search_creation_date" name="search_creation_date" value="<?php if(!empty($search_creation_date_show)) { echo date('m/d/Y',strtotime($search_creation_date_show)); } ?>" onkeydown="return false">
                ...
                <div class="col-md-6 col-xs-6 no-right-pad">
                    <div class="form-group">
                        <div class='input-group date creation_end_date' >
                            <input type="text" class="form-control searchAjax creation_end_date" placeholder="<?= lang('END_DATE'); ?>" id="creation_end_date" name="creation_end_date" value="<?php if(!empty($creation_end_date_show)) { echo date('m/d/Y',strtotime($creation_end_date_show)); } ?>" onkeydown="return false">
                            <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span> </div>
                    </div>
                </div>
                <div class="clr"></div>
...
<script type="text/javascript">
    ...
    {
        var export_url = '<?php echo base_url()."SupportContact/exportContact";?>';
