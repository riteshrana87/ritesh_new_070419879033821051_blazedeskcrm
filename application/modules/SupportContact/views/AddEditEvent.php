...
$path = base_url().'SupportContact/'.$formAction;
?>
  <div class="modal-dialog modal-lg">
      <?php $attributes = array("name" => "form_event", "id" => "form_event", 'data-parsley-validate' => "");
      ...
      <div class="modal-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="event_title" required="" id="event_title" value="<?php if(isset($editRecord[0]['event_title']) && $editRecord[0]['event_title'] !=''){ echo $editRecord[0]['event_title'];}?>" class="form-control"/>
                    </div>
                    ...
                    <div class = "col-xs-12 col-sm-3">
                        <label><?= $this->lang->line('EVENT_DATE') ?> : *</label>
                          <div class="input-group date" id="event_date">
                              ...
                              <input type="text" class="input-append date form_datetime form-control" required placeholder="<?= $this->lang->line('EVENT_DATE') ?>" id="event_date" name="event_date" onkeydown="return false" value="<?php
                                     if (!empty($editRecord[0]['event_date']) && $editRecord[0]['event_date'] != '0000-00-00') {
                                         echo date('YYYY-m-d H:i', strtotime($editRecord[0]['event_date']));
                                     } 
                                     ?>">
                    ...
                    <div class="input-group date" id="event_time">
                        ...
                        <input type="text" class="input-append date form_datetime form-control" required placeholder="<?= $this->lang->line('EVENT_DATE') ?>" id="event_time" name="event_time" onkeydown="return false" value="<?php
                        if (!empty($editRecord[0]['event_time']) && $editRecord[0]['event_time'] != '0000-00-00') {
                            echo date('H:i', strtotime($editRecord[0]['event_time']));
                        }
                        ?>" >
                        <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span> </div>
                </div>
                ...
                <div class = "col-sm-6">
                    ...
                    ?>
                    <div class="pad_top20">
                        <input <?php if (!empty($editRecord[0]['event_remember'])) { ?>checked="checked"<?php } ?> class="event_reminder_tog" data-toggle="toggle" data-onstyle="success" type="checkbox"  id="event_reminder" name="event_reminder" onChange="toggle_show(<?php echo "'#" . $reminder_id . "'"; ?>, this)"/>
                        <label>
<?= $this->lang->line('reminder?') ?>
                ...
                <div id="<?php echo $reminder_id; ?>">
                    ...
                    <div class = "col-sm-3">
                        ...
                        <div class="input-group date" id="reminder_time1">
                            ...
                            <input type="text" data-parsley-errors-container="#reminder_time_errors" class="input-append date form_datetime form-control" placeholder="<?= $this->lang->line('REMINDER_TIME') ?>" id="reminder_time" name="reminder_time" onkeydown="return false" value="<?php
                ...
                <div class ="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <label class="custom-upload btn btn-blue">Event Image 
...
<?php } else {
    ?>
        $('#event_date').datetimepicker({minDate: current_date, format: 'YYYY-MM-DD'});
<?php } ?>
