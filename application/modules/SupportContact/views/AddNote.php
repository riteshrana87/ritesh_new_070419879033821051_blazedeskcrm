               ...
               <?php  }
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                             <input <?php if (!empty($editRecord[0]['add_to_communication'])) { ?>checked="checked"<?php } ?> class="toggle_add_to_communication" data-toggle="toggle" data-onstyle="success" type="checkbox"  id="add_to_communication" name="add_to_communication"/>
                        </div>
