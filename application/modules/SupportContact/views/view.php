                ...
                <div class="navbar-form navbar-left pull-right" id="searchForm">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button onclick="data_search()" class="btn btn-default" type="button"><i class="fa fa-search fa-x"></i></button>&nbsp;

                            <button class="btn btn-default" title="Reset" onclick="reset_data()"><i class="fa fa-refresh fa-x"></i></button>
                        </span> </div>
                    <!-- /input-group -->
                </div>
            </div>
                ...
                <div class="col-xs-12 col-md-12 col-sm-12 font-12em">
                    ...
                    <div class="row">
                        <div class="pad-6">
                            ...
                            <div class="col-xs-12 col-md-9">
                                <a class="btn btn-blue" data-href="<?php echo base_url() . "SupportContact/send_email_view/" . $all_records[0]['contact_id']; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('SEND_EMAIL'); ?>"><i class="fa fa-envelope"></i>&nbsp;&nbsp;<span><?php echo lang('SEND_EMAIL'); ?></span></a>&nbsp;&nbsp;&nbsp;
                                <a class="btn btn-blue" data-href="<?php echo base_url() . "SupportContact/scheduleMeeting/" . $all_records[0]['contact_id']; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('SCHEDULE_MEETING'); ?>"><i class="fa fa-calendar"></i>&nbsp;&nbsp;<span><?php echo lang('SCHEDULE_MEETING'); ?></span></a>&nbsp;&nbsp;&nbsp;
                                <a class="btn btn-blue" id ="navigate_contact" data-href="<?php echo base_url() . "SupportContact/navigation/" . $all_records[0]['contact_id']; ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('NAVIGATE_CONTACT'); ?>"><i class="fa fa-map-marker"></i><span>&nbsp;&nbsp;<?php echo lang('NAVIGATE_CONTACT'); ?></span></a>
                            </div>
                            <div class="clr"></div>
                        </div>
                    </div>
                            ...
                            <div class="client-img">
                                <?php if (isset($all_records[0]['image']) && $all_records[0]['image'] != "") { ?>
                                    ...
                                    if (isset($all_records[0]['image']) && $all_records[0]['image'] != "") {
                                        $img_alt = $all_records[0]['contact_name'];
                                    } else {
                                        $img_alt = "No Image";
                                    }
                                    ?>
...
<?php } ?>
                ...
                <?php
                if (checkPermission('SupportContact', 'edit')) {
                    ?>
                <div class="pad-tb6">
                    <a data-href="<?= base_url() ?>SupportContact/edit/<?= $all_records[0]['contact_id'] ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="Edit"><i class="fa fa-edit bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('edit');?> </a>
                </div>
...
if (checkPermission('SupportContact', 'add')) {
    ?>
                ...
                <div>
                    <a data-href="<?= base_url() ?>SupportContact/addNote/<?= $all_records[0]['contact_id'] ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('ADD_NOTES'); ?>"><i class="fa fa-comment bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('ADD_NOTES'); ?></a>
                </div>
<?php } ?>
                <div>
                   ...
                   <?php
if (checkPermission('SupportContact', 'add')) {
    ?> <a data-href="<?= base_url() ?>SupportContact/addTask/<?= $all_records[0]['contact_id'] ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('ADD_TASKS'); ?>"><i class="fa fa-file-text bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('ADD_TASKS'); ?></a>
                </div>
<?php } ?>
                <!--<div>
                <?php
...
if (checkPermission('SupportContact', 'add')) {
    ?>
                <div>
                    <a data-href="<?= base_url() ?>SupportContact/view_event/<?= $all_records[0]['contact_id'] ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('ADD_EVENTS'); ?>"><i class="fa fa-tag bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('ADD_EVENTS'); ?></a>
                </div>
                <div class="grayline-1"></div>
            <?php }
            ?>
           ...
           <!-- <div class="pad-tb6">
            <?php if (checkPermission('SupportContact', 'add')) { ?>
            ...
            <div class="pad-tb6">
            <?php if (checkPermission('SupportContact', 'add')) { ?>
                    <a data-href="<?php echo base_url() . 'SupportContact/AddCases/' . $all_records[0]['contact_id']; ?>"  aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('add_cases'); ?>"><i class="fa fa-sitemap bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('add_cases'); ?> </a>
...
<?php
if (checkPermission('SupportContact', 'view')) {
    ?>
                <div>
                    <a data-href="<?= base_url() ?>SupportContact/viewMergeContact/<?= $all_records[0]['contact_id'] ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('CONTACT_MERGE_DUPLICATE'); ?>"><i class="fa fa-exchange bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('CONTACT_MERGE_DUPLICATE'); ?> </a>
                </div> 
...
<?php } ?>
<?php
if (checkPermission('SupportContact', 'delete')) {
    ?>
                <div>
                    <a onclick="delete_contact('<?php echo $all_records[0]['contact_id']; ?>', '<?php echo base_url('SupportContact'); ?>');" title="<?php echo lang('CONTACT_DELETE'); ?>"><i class="fa fa-remove bluecol"></i>&nbsp;&nbsp;&nbsp;<?php echo lang('CONTACT_DELETE'); ?> </a>
                </div>
<?php } ?>
...
if (checkPermission('SupportContact', 'add')) {
    ?>
                <div class="pad-10 text-center">
                    <a data-href="<?= base_url() ?>SupportContact/view_add_file/<?= $all_records[0]['contact_id'] ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('ADD_FILE_TO_CONTACT'); ?>" class="width-100 btn small-white-btn2"><?php echo lang('ADD_FILE_TO_CONTACT'); ?></a>
                </div>
<?php } ?>
...
//not included in loadjsFiles bcoz there are to many validations are working as global
    ...
    {
        //var url_contact = '<?php echo base_url() . "SupportContact/delete_note" ?>';
        var delete_url = "<?= base_url() ?>/SupportContact/delete_note/?note_id=" + note_id + "&link=" + redirect_link;
        var delete_meg ='<?php echo $this->lang->line('CONFIRM_DELETE_NOTE');?>';
    ...
    {
        var delete_url = "<?= base_url() ?>/SupportContact/delete_task/?task_id=" + task_id + "&link=" + redirect_link;
        var delete_meg ='<?php echo $this->lang->line('CONFIRM_DELETE_TASK');?>';
    BootstrapDialog.show(
        {
            title: '<?php echo $this->lang->line('Information');?>',
            message: delete_meg,
    ...
    function getNoteData(searchtext)
    {
        ...
        var url_contact = '<?php echo base_url() . "SupportContact/viewNoteData/" ?>';
        $.ajax({
            type: "POST",
            url: url_contact,
    ...
    function getTasksData(searchtext)
    {
        ...
        var url_contact = '<?php echo base_url() . "SupportContact/viewTaskData/" ?>';
        $.ajax({
            type: "POST",
            url: url_contact,
    ...
    {
        var url_contact = '<?php echo base_url() . "SupportContact/viewDealsData/" ?>';
        $.ajax({
            type: "POST",
            url: url_contact,
    ...
    {
        var url_contact = '<?php echo base_url() . "SupportContact/getContactFile/" ?>';
        $.ajax({
            type: "POST",
            url: url_contact,
    ...
    {
        var url_contact = '<?php echo base_url() . "SupportContact/getContactCases/" ?>';
        $.ajax({
            type: "POST",
            url: url_contact,
    ...
    {
        var url_contact = '<?php echo base_url() . "SupportContact/getContactEvents/" ?>';
        $.ajax({
            type: "POST",
            url: url_contact,
    ...
    {
        var url_contact = '<?php echo base_url() . "SupportContact/getContactCommunication/" ?>';
        $.ajax({
            type: "POST",
            url: url_contact,
    ...
    {
        var url_contact = '<?php echo base_url() . "SupportContact/getContactMeeting/" ?>';
        $.ajax({
            type: "POST",
            url: url_contact,
    ...
    function delete_contact(contact_id, redirect_link) {
        ...
        var delete_url = '<?php echo base_url(); ?>' + "SupportContact/deletedata/?id=" + contact_id + "&link=" + redirect_link;
    ...
    function duplicate_contact(contact_id) {
        ...
        var duplicate_url = '<?php echo base_url(); ?>' + "SupportContact/createDuplicate/?id=" + contact_id;
        var delete_meg ="<?php echo $this->lang->line('CONFIRM_DUPLICATE_CONTACT');?>";
    BootstrapDialog.show(
        {
            title: '<?php echo $this->lang->line('Information');?>',
            message: delete_meg,
