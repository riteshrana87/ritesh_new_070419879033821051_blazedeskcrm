...
$path = base_url() . 'SupportContact/sendEventEmail'  ;
?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
           ...
           <div class="row"> 
            <div class="col-xs-12 col-md-5 no-right-pad">
                <div class="form-group">
                    <select multiple="" name="receipent_email[]" id="receipent_email" class="form-control chosen-select" required data-parsley-errors-container="#prospect_owner_error">
                        <option value=""><?php echo lang('SELECT_RECEIPENT_EMAIL');?></option>
                         <?php
           ...
           <div class="row"> 
            ...
            <div class="col-xs-11 col-md-5 col-lg-5 no-right-pad">
                <div class="form-group">
            ...
            <div class="col-xs-6 col-md-3 no-right-pad col-lg-3">
                <div class="text-center">
                    <a class="btn btn-primary col-xs-12 col-md-12" id="check-textarea"><?php echo lang('CHECK_SPELLING');?></a>
                </div>
                <div class="clr"> </div><br/>
                <div class="text-center">
                    <a class="btn btn-primary col-xs-12 col-md-12" onclick="markAsImportant();" id="mark_important"><?php echo lang('FLAG_AS_IMPORTANT');?></a>
                </div>
                <div class="clr"> </div><br/>
                <div class="text-center">
                    <a class="btn btn-primary col-xs-12 col-md-12"><?php echo lang('REQUEST_REAR_NOTIFICATION');?></a>
                </div>
                <div class="clr"> </div><br/>
                <div class="text-center">
                    <button class="btn btn-primary col-xs-12 col-md-12"><?php echo lang('SEND_MEETING_DATE');?></button>
                </div>
                <div class="clr"> </div>
            ...
            <input type="hidden" name="hdn_contact_id" id="hdn_contact_id" value="<?php if($contact_id){ echo $contact_id;} ?>"/>
...
<script type="text/javascript">
    ...
    function autoFillEmailTemplate(template_id)
    {
        ...
        $.ajax({
        type: "POST",
        url: '<?php echo base_url()."SupportContact/getEmailTemplateDataById"; ?>',
