    ...
    <div class="table table-responsive">
        <table class="table table-responsive" >
            <thead>
                <tr>
                    <th class='sortTask'>
                        <a    href="<?php echo base_url(); ?>SupportContact/getContactMeeting/?orderField=meeting_date&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a    href="<?php echo base_url(); ?>SupportContact/getContactMeeting/?orderField=meet_title&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a    href="<?php echo base_url(); ?>SupportContact/getContactMeeting/?orderField=mm.created_date&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    //$redirect_link = base_url()."Contact/view/".$note['notes_related_id'];
                        if (strpos($_SERVER['HTTP_REFERER'], 'Lead') !== false) {
                            ...
                            elseif(strpos($_SERVER['HTTP_REFERER'], 'SupportContact') !== false) {
                                $redirect_link = base_url()."SupportContact/view/".$event['meet_related_id'];
                            }
...
{
    var delete_url = "../../SupportContact/delete_meeting?meeting_id=" + meeting_id +"&link=" + redirect_link;

    var delete_meg ="<?php echo $this->lang->line('CONFIRM_DELETE_MEETING');?>";
