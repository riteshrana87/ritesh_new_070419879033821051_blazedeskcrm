    ...
    <div class="table table-responsive">
        <table class="table table-responsive" >
            <thead>
                <tr role="row">
                    <th class='sortTask'>
                        <a    href="<?php echo base_url(); ?>SupportContact/viewTaskData/?orderField=task_name&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>SupportContact/viewTaskData/?orderField=importance&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>SupportContact/viewTaskData/?orderField=start_date&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>SupportContact/viewTaskData/?orderField=end_date&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                    ...
                                    <?php foreach ($task_data as $task_data) {
                                        ...
                                        <tr id="task_id_<?php echo $task_data['task_id']; ?>">
                                            ...
                                            <td class="bd-actbn-btn"> 
                                                <?PHP if (checkPermission('SupportContact', 'edit')) { ?><a data-href="<?php echo base_url('SupportContact/edittask/'.$task_data['task_id'].''); ?>" title="<?= $this->lang->line('edit') ?>" data-toggle="ajaxModal" aria-hidden="true" data-refresh="true"><i class="fa fa-pencil bluecol"></i></a><?php } ?>
                                                 <?PHP if (checkPermission('SupportContact', 'delete')) { ?><a title="<?= $this->lang->line('delete') ?>" onclick="delete_task('<?php echo $task_data['task_id']; ?>','<?php echo $redirect_link;?>');"><i class="fa fa-remove redcol"></i></a><?php } ?>      
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php }else{ ?>
