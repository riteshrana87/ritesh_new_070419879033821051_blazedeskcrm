...
$path = base_url() . 'SupportContact/' . $form_action;
?>
            ...
            <div id="<?php echo $reminder_id; ?>">
                     <div class = "col-sm-4">
                                ...
                                <div class="input-group date" id="reminder_date">
                                    ...
                                    <input type="text" class="input-append date form_datetime form-control" required placeholder="<?= $this->lang->line('REMINDER_DATE') ?>" id="reminder_date" name="reminder_date" onkeydown="return false" value="<?php
                            ...
                            <div class = "col-sm-4">
                                ...
                                <div class="input-group date" id="reminder_time">
                                    ...
                                    <input type="text" class="input-append date form_datetime form-control" required placeholder="<?= $this->lang->line('REMINDER_TIME') ?>" id="reminder_time" name="reminder_time" onkeydown="return false" value="<?php
                    ...
                    <select name="company_id_location" class="chosen-select" onchange="getCompany_location(this.value);" data-placeholder="<?php echo lang('SELECT_COMPANY_LOCATION'); ?>" id="company_id_location" data-parsley-errors-container="#location-errors">
                        ...
                        foreach ($company_data as $company) {
                            ...
                            <option value="<?php echo $company['company_id'] ?>" <?php
                                    if (isset($editRecord[0]['company_id_location']) && $company['company_id'] == $editRecord[0]['company_id_location']) {
...
?>
                ...
                <div class = "col-sm-3">
                    <div class="pad_top20">
                       <div class="pull-left"> <input <?php if (!empty($editRecord[0]['is_another_location'])) { ?>checked="checked"<?php } ?> data-on="<?php echo lang('on'); ?>" data-off="<?php echo lang('off'); ?>" class="event_reminder_tog" data-toggle="toggle" data-onstyle="success" type="checkbox" id="is_another_location" name="is_another_location"/></div>
