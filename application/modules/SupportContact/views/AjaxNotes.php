            ...
            <thead>
                <tr role="row">
                    ...
                    <th class='sortTask'>
                        ...
                        <a    href="<?php echo base_url(); ?>SupportContact/viewNoteData/?orderField=created_date&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                ...
                { 
                    ...
                    <tr id="note_id_<?php echo $note['note_id']; ?>">
                        ...
                        <td class="bd-actbn-btn">
                            <a data-href="<?= base_url() ?>SupportContact/viewNote/<?= $note['note_id'] ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('VIEW_NOTES'); ?>"><i class="fa fa-search greencol"></i></a>
                            <a data-href="<?= base_url() ?>SupportContact/updateNote/<?= $note['note_id'] ?>" aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" title="<?php echo lang('UPDATE_NOTES'); ?>"><i class="fa fa-pencil bluecol"></i></a>
