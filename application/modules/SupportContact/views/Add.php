  ...
  <!-- Modal content-->
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class=" row">
                    <div class="col-sm-6 form-group">
                        <select class="chosen-select form-control" data-placeholder="<?=$this->lang->line('select_country')?>*" onchange="api_call();"  name="country_id" id="country_id" required data-parsley-errors-container="#country-errors">
                            ...
                            <?php if (isset($company_data) && count($company_data) > 0) { ?>
                                <?php foreach ($company_data as $company_data) { ?>
                                    <option value="<?php echo $company_data['company_id']; ?>"
                                        ...
                                        { echo 'selected'; }  ?>>
                                        <?php echo htmlentities(stripslashes($company_data['company_name'])); ?>
                                    </option>
                                <?php } ?>
                            <?php } ?>
                        </select>
          ...
          <div class = " row" id="second_time_hide">
              ...
              <div class="row">
                ...
                <div class=" row">
                    <div class="col-sm-6 form-group">
                        <input type="text" name="contact_for" class="form-control" id="contact_for" placeholder="<?=$this->lang->line('contact_for')?>" value="<?=!empty($editRecord[0]['contact_for'])?$editRecord[0]['contact_for']:''?>" />
                    </div>
                    <div class="col-sm-6 form-group">
                ...
                <div class=" row">
                     <div class="col-sm-6 form-group">
                        <input type="text" class="form-control" placeholder="<?= $this->lang->line('postal_code') ?>" id="postal_code" name="postal_code" value="<?php if(!empty($editRecord[0]['postal_code'])) { echo htmlentities(stripslashes($editRecord[0]['postal_code'])); }?>">
                    </div>
                    <div class="col-sm-6 form-group">
                        <input type="text" name="job_title" class="form-control" id="job_title" placeholder="<?=$this->lang->line('job_title')?>" value="<?=!empty($editRecord[0]['job_title'])?$editRecord[0]['job_title']:''?>" />
                        </div>
...
<!--                        <option value="">
            ...
            <?php if((count($newsletterLists) > 0) && $checkUserIsCrm == true)
            {?>
            <div class=" row">
                <div class="col-sm-6 form-group">
      ...
      <div class="modal-footer">
        <center> <input type="submit" class="btn btn-primary" id="contact_submit_btn" value="<?=  $modal_title?>"></center>
      </div>
    </div>
  <?php echo form_close(); ?>
  </div>
