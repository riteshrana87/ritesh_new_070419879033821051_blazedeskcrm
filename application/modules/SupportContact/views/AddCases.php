            ...
            <div class="modal-body">
                ...
                <div class = " row">
                    <div class = "col-lg-6 col-sm-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Business Cases" id="business_cases" name="business_cases" value="<?= !empty($edit_record[0]['business_cases']) ? $edit_record[0]['business_cases'] : '' ?>" required>
                    </div>
                    
                    <div class = " col-lg-6 col-sm-6 col-md-6 col-sm-6 col-xs-12 form-group">
                        <label class="control-label"><?= lang('CASE_SUBJECT') ?>*</label>
                        <input type="text" class="form-control" placeholder="Case Subject" id="business_subject" name="business_subject" value="<?= !empty($edit_record[0]['business_subject']) ? $edit_record[0]['business_subject'] : '' ?>" required>
                    </div>
                ...
                <div class = " row">
                    ...
                    <div class = "col-sm-6 form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Deadline" id="deadline" name="deadline" onkeydown="return false" value="<?= !empty($edit_record[0]['deadline']) ? $edit_record[0]['deadline'] : '' ?>" required>
                    </div>
...
<script type="text/javascript">
    ...
    $('.delete_file').on('click', function () {
        ...
        var delete_meg ="<?php echo $this->lang->line('common_delete_file');?>";
