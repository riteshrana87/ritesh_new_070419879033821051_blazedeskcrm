...
<h3 class="white-link"><?=$this->lang->line('sales_target_list')?></h3> 
	</div>
<?php if(checkPermission('SalesTargetSettings','add')){?>
 		 <div class="col-xs-6 col-sm-3 col-md-2 col-lg-2 col-sm-offset-3 col-md-offset-4 text-right">
			<a data-href="<?php echo base_url($crnt_view.'/add');?>" data-toggle="ajaxModal" class=" btn btn-white"><?=$this->lang->line('add_target')?></a>
    	</div>
  	 <?php }?>  	    
</div>
<div class="clr"></div>
