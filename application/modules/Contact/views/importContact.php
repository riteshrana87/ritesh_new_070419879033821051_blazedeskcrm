        ...
        <div class="modal-body">
            <div class="form-group row">
                <div class="col-sm-6 col-lg-12 form-group">
                    <label class="custom-upload btn btn-blue"><?= $this->lang->line('import_contact') ?> 
                ...
                <div class="col-sm-6 col-lg-12">
                    <a class="btn btn-green" downlaod target="_blank" href="<?php echo base_url() . "uploads/csv_contact/SAMPLE_CSV_CONTACT.xlsx"; ?>"><span class="glyphicon glyphicon-cloud-download"></span>
                ...
                <ul class="bd-gen-list">
                   ...
                   <!-- <li><span class="colo"><?php echo lang('UPLOAD_COMPANY_NAME_MUST_BE_EXISTED');?></span></li>-->
                    ...
                    <li><span class="colo"><?php echo lang('REQUIRED_FILEDS');?></span>
                        <ul>
                            <li><?php echo lang('CONTACT_REQUIRED_EMAIl');?></li>
                            
                        </ul>
                    </li>
                     <li><span class="colo"><?php echo lang('DUPLICATE_CONTACT_MSG');?></span></li>
                     <li><span class="colo"><?php echo lang('COMPANY_BRANCH_EXISTED');?></span></li>
                </ul></div></div>
            </div>
