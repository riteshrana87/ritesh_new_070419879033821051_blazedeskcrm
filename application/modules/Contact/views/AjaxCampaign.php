    ...
    <div class="table table-responsive">
        <table class="table table-responsive" >
            <thead>
                <tr role="row">
                    <th class='sortTask'>
                        <a    href="<?php echo base_url(); ?>Contact/viewCampaignData/?orderField=campaign_contact_id&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Contact/viewCampaignData/?orderField=campaign_id&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
            ...
            <?php foreach($campaign_info as $data){ 
                $redirect_link = base_url()."Contact/view/".$data['campaign_related_id'];
                ?>
                <tr>
...
{
    var delete_url = "<?php echo base_url();?>Contact/delete_campaign?campaign_contact_id=" + campaign_contact_id ;
    var delete_meg ="<?php echo lang('confirm_delete_campaign'); ?>";
...
{
    var delete_url = "<?php echo base_url();?>Contact/deleteLeadCampaign?lead_id=" + lead_id ;
    var delete_meg ="<?php echo lang('confirm_delete_campaign'); ?>";
    BootstrapDialog.show(
        {
            title: '<?php echo $this->lang->line('Information');?>',
...
{
    var delete_url = "<?php echo base_url();?>Contact/deleteProspectCampaign?prospect_id=" + prospect_id ;
    var delete_meg ="<?php echo lang('confirm_delete_campaign'); ?>";
    BootstrapDialog.show(
        {
            title: '<?php echo $this->lang->line('Information');?>',
