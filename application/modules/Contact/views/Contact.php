...
<div class="row">
                ...
                <div class="navbar-form navbar-left pull-right" id="searchForm">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button onclick="data_search('changesearch')" class="btn btn-default" type="button" title="<?php echo lang('search');?>"><i class="fa fa-search fa-x"></i></button>&nbsp;
    ...
    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-3 col-sm-3 col-lg-5">
                <h3 class="white-link"><?php echo lang('contacts');?></h3>
            </div>
            <div class="col-xs-12 col-md-9 col-sm-9 col-lg-7 pull-right text-right">
        ...
        <div class="whitebox" id="common_div">
            <?= $this->load->view('Contact/ajax_list.php', '', true); ?>
            <div class="clr"></div>
        </div>
    </div>
           ...
           <?php
            ...
            ?>
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class='input-group date' >
                            <input type="text" class="form-control search_creation_date" placeholder="<?= lang('start_date'); ?>" id="search_creation_date" name="search_creation_date" value="<?php if(!empty($search_creation_date_show)) { echo configDateTime($search_creation_date_show); } ?>" onkeydown="return false">
                ...
                <div class="col-md-6 col-xs-6 no-right-pad">
                    <div class="form-group">
                        <div class='input-group date' >
                            <input type="text" class="form-control searchAjax creation_end_date" placeholder="<?= lang('END_DATE'); ?>" id="creation_end_date" name="creation_end_date" value="<?php if(!empty($creation_end_date_show)) { echo configDateTime($creation_end_date_show); } ?>" onkeydown="return false">
                            <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span> </div>
                    </div>
                </div>
                <div class="clr"></div>
...
<div class="row">
            ...
            <?php } ?>
            <div class="col-md-2 col-new-71 col-xs-12"> <a class="btn btn-white full-width" href="<?php echo base_url('Opportunity'); ?>"><?php echo $this->lang->line('manage_opportunities') ?></a> </div>
...
<script type="text/javascript">
    ...
    function exportContact()
    {
        ...
        var delete_meg ="<?php echo lang('CONFIRM_EXPORT_CONTACT'); ?>";
        BootstrapDialog.show(
            {
                title: '<?php echo $this->lang->line('Information');?>',
                message: delete_meg,
