...
$path = base_url() . 'Contact/sendProspectEmail'  ;
?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row"> 
           ...
           <div class="row"> 
               <div class="col-xs-6  no-left-pad">
                <div class="form-group">
                    <select name="company_id" id="company_id" class="form-control chosen-select" data-parsley-errors-container="#company_id_error" disabled="true">
                        ...
                        { ?>
                        <option value="<?php echo $company['company_id'];?>" <?php if($company['company_id'] == $company_id){ echo "selected='selected'";}?>><?php echo $company['company_name'];?></option>  
                       <?php  } ?>
                    </select>
            ...
            <div class="col-xs-6  no-right-pad">
                <div class="form-group">
                    <select name="prospect_owner" id="prospect_owner" class="form-control chosen-select" disabled="true" required data-parsley-errors-container="#prospect_owner_error">
                        ...
                        {?>
                        <option value="<?php echo $company_data['contact_id']?>" <?php if($company_data['contact_id'] == $contact_id){ echo "selected='selected'";} ?>> <?php echo $company_data['contact_name']?></option>
                       <?php } ?>
...
<script type="text/javascript">
    ...
    function autoFillEmailTemplate(template_id)
    {
        ...
        if(template_id != '')
        {
            $.ajax({
            type: "POST",
            url: '../../Contact/getEmailTemplateDataById',
