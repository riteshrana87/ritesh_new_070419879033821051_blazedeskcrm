    ...
    <div class="table table-responsive">
        <table class="table table-responsive" >
            <thead>
                <tr role="row">
                    <th class='sortTask'>
                        <a    href="<?php echo base_url(); ?>Contact/viewDealsData/?orderField=prospect_name&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Contact/viewDealsData/?orderField=prospect_auto_id&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Contact/viewDealsData/?orderField=contact_count&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Contact/viewDealsData/?orderField=contact_name&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Contact/viewDealsData/?orderField=creation_date&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                            if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
                                echo $taskSortAsc;
                            } else if ($tasksortOrder == 'asc' && $tasksortField == 'created_date') {
