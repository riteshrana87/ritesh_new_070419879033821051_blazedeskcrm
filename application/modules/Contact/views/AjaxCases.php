    ...
    <div class="table table-responsive">
        <table class="table table-responsive" >
            <thead>
                <tr role="row">
                    <th class='sortTask'>
                        <a    href="<?php echo base_url(); ?>Contact/getContactCases/?orderField=title&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a    href="<?php echo base_url(); ?>Contact/getContactCases/?orderField=incident_type_name&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a    href="<?php echo base_url(); ?>Contact/getContactCases/?orderField=business_cases&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Contact/getContactCases/?orderField=business_subject&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Contact/getContactCases/?orderField=responsible&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Contact/getContactCases/?orderField=deadline&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                    ...
                    <th class='sortTask'>
                        <a  href="<?php echo base_url(); ?>Contact/getContactCases/?orderField=incident_status&sortOrder=<?php echo $tasksortOrder ?>">
                            <?php
                                ...
                                <tr id="cases_<?php echo $data['cases_id'];?>">
                                    ...
                                    <td  class="bd-actbn-btn">
                                        ...
                                        <?php  if (strpos($redirect_link, 'Contact/view') !== false) {
                                            ...
                                            ?>
                                                <a data-href="<?=base_url('Contact/viewCasesRecord/'.$data['cases_id'])?>" title="<?= $this->lang->line('view') ?>"  data-toggle="ajaxModal" aria-hidden="true" class="edit_contact" ><i class="fa fa-search fa-x greencol"></i></a>
                                         <?php } }?>
                                        ...
                                        <?php  if (strpos($redirect_link, 'Account/viewLostClient') !== false) {
                                         ...
                                         <?php  if (strpos($redirect_link, 'Contact/view') !== false) {
                                            ...
                                            ?>
                                       <a  data-href="<?php echo base_url('Contact/editCases/'.$data['cases_id']); ?>" title="<?= $this->lang->line('edit') ?>" data-toggle="ajaxModal" aria-hidden="true" data-refresh="true" class="edit_opportunity" id="edit_opportunity" ><i class="fa fa-pencil fa-x bluecol"></i></a>
                                       <?php } }?>
                                      ...
                                      <?php  if (strpos($redirect_link, 'Contact/view') !== false) {
                                            ...
                                            ?>
                                        <a data-href="javascript:;" title="<?= $this->lang->line('delete') ?>" onclick="delete_request_cases('<?php echo $data['cases_id']; ?>','<?php echo $redirect_link;?>');" ><i class="fa fa-remove fa-x redcol" ></i></a>
                                        <?php } }?>
                                        <?php  if (strpos($redirect_link, 'Lead/viewdata') !== false) {
