                        ...
                        if(isset($file_data) && count($file_data) > 0)
                        {
                            ...
                            <li id="contact_file_<?php echo $data['file_id'];?>" class="bd-contact-rmv">
                                ...
                                <?php  if (strpos($redirectLink, 'Contact/view') !== false) {
                                            ...
                                            ?>
								<i class="fa fa-remove" title="<?= $this->lang->line('delete') ?>" onclick="delete_contact_file('<?php echo $data['file_id'];?>','<?php echo $data['file_path'] ?>','<?php echo $_SERVER['HTTP_REFERER']; ?>')"></i>
								<?php } }?>
...
{
    var delete_url = "../../Contact/delete_contact_attach/?file_id=" + file_id+"&file_path="+file_path+"&redirect_link="+redirect_link;
