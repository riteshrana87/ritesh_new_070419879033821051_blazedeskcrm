    ...
    <div class="table table-responsive">
        <table class="table table-responsive" >
            <thead >
                                <tr>
                                    <th class='sortTask'>
                                        <a    href="<?php echo base_url(); ?>Contact/getContactCommunication/?orderField=comm_date&sortOrder=<?php echo $tasksortOrder ?>">
                                            <?php
                                    ...
                                    <th class='sortTask'>
                                        <a    href="<?php echo base_url(); ?>Contact/getContactCommunication/?orderField=comm_type&sortOrder=<?php echo $tasksortOrder ?>">
                                            <?php
                                    ...
                                    <th class='sortTask'>
                                        <a    href="<?php echo base_url(); ?>Contact/getContactCommunication/?orderField=comm_sender&sortOrder=<?php echo $tasksortOrder ?>">
                                            <?php
                                    ...
                                    <th class='sortTask'>
                                        <a    href="<?php echo base_url(); ?>Contact/getContactCommunication/?orderField=comm_subject&sortOrder=<?php echo $tasksortOrder ?>">
                                            <?php
                                    ...
                                    <th class='sortTask'>
                                        <a    href="<?php echo base_url(); ?>Contact/getContactCommunication/?orderField=comm_receiver&sortOrder=<?php echo $tasksortOrder ?>">
                                            <?php
