...
<div class="row">
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
      <h3 class="white-link">
        <?=$this->lang->line('currency_settings_menu_hader')?>
      </h3>
    </div>
    <?php if(checkPermission('Currencysettings','add')){?>
    <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2 col-sm-offset-3 col-md-offset-4 text-right"> <a data-href="<?php echo base_url($crnt_view.'/add');?>" data-toggle="ajaxModal" class="btn btn-white" aria-hidden="true" data-refresh="true" >
...
$(document).ready(function () {  
    ...
    function bindClicksSort() {
        $("body").delegate('th.sortCurrencySettingsList a', 'click', (paginationClick));
    }
