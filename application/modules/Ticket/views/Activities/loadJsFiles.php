...
<script type="text/javascript">
    ...
    function data_group(fieldName, data)
    {
        ...
        $.ajax({
            ...
            data: {
                result_type: 'ajax', perpage: $("#perpage").val(), searchtext: $("#search_input").val(), sortfield: $("#sortfield").val(), sortby: $("#sortby").val(), allflag: 'changesearch', groupFieldName: groupFieldName, groupFieldData: groupFieldData
            },
            beforeSend: function () {
    ...
    function data_search(allflag)
    {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('Projectmanagement/' . $this->viewname); ?>/index/" + uri_segment,
            data: {
                result_type: 'ajax', perpage: $("#perpage").val(), searchtext: $("#search_input").val(), sortfield: $("#sortfield").val(), sortby: $("#sortby").val(), allflag: allflag, groupFieldName: groupFieldName, groupFieldData: groupFieldData
            },
            beforeSend: function () {
                $('#common_div').block({message: 'Loading...'});
            },
    ...
    $('body').on('click', '#common_tb ul.pagination a.ajax_paging', function (e) {
        ...
        $.ajax({
            ...
            url: $(this).attr('href'),
            data: {
                result_type: 'ajax', perpage: $("#perpage").val(), searchtext: $("#search_input").val(), sortfield: $("#sortfield").val(), sortby: $("#sortby").val(), groupFieldName: groupFieldName, groupFieldData: groupFieldData
            },
            beforeSend: function () {
                $('#common_div').block({message: 'Loading...'});
            },
