...
if (!empty($edit_record[0]['status_type'])) {

    if ($edit_record[0]['status_type'] == 4) {
        $formAction = 'insertLostdata';
        $path = 'Account/' . $formAction;
    } else {
...
<?php
$attributes = array("name" => "add_opportunity", "id" => "add_opportunity", 'data-parsley-validate' => "");
...
?>
        ...
        <div class="modal-body">
            <div class = " row">
                <div class = "col-sm-7 form-group">
                    ...
                    <input type="hidden" id="hdn_contact_id" name="hdn_contact_id" value="<?php
    ...
    ?>"/>
                    ...
                    <input type="hidden" id="requirement_id" name="requirement_id"  value="<?php
                    if (!empty($opportunity_requirement[0]['requirement_id'])) {
                        echo $opportunity_requirement[0]['requirement_id'];
                    }
                    ?>">
                    <input type="hidden" id="prospect_id" name="prospect_id"   value="<?php
                           if (!empty($edit_record[0]['prospect_id'])) {
                               echo $edit_record[0]['prospect_id'];
                           }
                           ?>">
                    <input type="text" class="form-control" placeholder="<?= $this->lang->line('opportunity_name') ?> *" id="prospect_name" name="prospect_name" value="<?php
            ...
            <div class = " row">
                <div class = "col-sm-7 form-group">
                    <select name="country_id" onchange="api_call();" class="form-control chosen-select" id="country_id" data-placeholder=" <?= $this->lang->line('select_country') ?> *" required tabindex="2" data-parsley-errors-container="#country-errors">
                        <option value="">
...
<?php if (isset($company_data) && count($company_data) > 0) { ?>
    <?php foreach ($company_data as $company_data) { ?>
            ...
            <div class = " row" id="second_time_hide">
                ...
                <div class = "col-sm-3 form-group">
                    <input type="email" class="form-control" placeholder="<?= $this->lang->line('email_id_company') ?> *" data-parsley-trigger="change" id="email_id_company" name="email_id_company">
                </div>
                <div class = "col-sm-3 form-group">
            ...
            <div class = " row">
                ...
                <div class = "col-sm-5 form-group">
                    <select name="language_id" class="form-control chosen-select" data-placeholder="<?= $this->lang->line('language_not_filled') ?>" id='language_id' tabindex="11">
                        <option value="">
                    <?= $this->lang->line('language_not_filled') ?>
                        </option>
    ...
    <?php foreach ($EstimateArray as $result) { ?>
        ...
        ?>><?php echo $result['subject']; ?></option>
            ...
            <div class = "row">
                ...
                <div class = "col-xs-12 col-sm-6 col-md-6 form-group">
<?php if (!empty($edit_record[0]['status_type']) && ($edit_record[0]['status_type'] == "" )) {
    if ($edit_record[0]['status_type'] == 3 || $edit_record[0]['status_type'] == 4) { ?>
...
<?= $this->lang->line('office') ?>
                        ...
                        <div class = "col-xs-12 col-sm-6 col-md-6 form-group">
                            <input type="text" class="form-control" placeholder="<?= $this->lang->line('number') ?>" id="phone_no1_opportunity" name="phone_no1_opportunity"  data-parsley-pattern='^[\d\+\-\.\(\)\/\s]*$' maxlength="25" value="<?php
...
<?= $this->lang->line('office') ?>
                        ...
                        <div class = "col-xs-12 col-sm-6 col-md-6 form-group">
                            <input type="text" class="form-control" placeholder="<?= $this->lang->line('number') ?>" id="phone_no2_opportunity" name="phone_no2_opportunity"  maxlength="25" data-parsley-pattern="^[\d\+\-\.\(\)\/\s]*$"  value="<?php
            ...
            <div id="add_more" class=" add_contacts">
                        ...
                        <div class = " row contacts" id="add_contact<?php echo $contact['contact_id']; ?>">
                            <div class = "col-sm-2 col-lg-2 text-right pad-t6 form-group txt-left-resp">
                        ...
                        ?>">
                            ...
                            <div class = "col-sm-3 form-group">
                                <input type="email" class="form-control" placeholder="<?= $this->lang->line('email_address') ?> *" onchange='validateContactUniqueness(this.value, "<?php echo $delete_count; ?>")' data-parsley-trigger="change" name="email_id[]" id="email_id<?php echo $delete_count; ?>" value="<?php
                            ...
                            <div class = "col-sm-3 form-group">
                                <input type="text" class="form-control" placeholder="<?= $this->lang->line('phone_no') ?> *" name="phone_no[]"  id="phone_no<?php echo $delete_count; ?>"  maxlength="25" data-parsley-pattern="^[\d\+\-\.\(\)\/\s]*$"  value="<?php
                                if (!empty($contact['mobile_number'])) {
                                    echo $contact['mobile_number'];
                                }
                                ?>" required>
                            </div>
                            <div class = "bd-error"> <a class="delcontacts" href="javascript:;" title="<?= $this->lang->line('delete') ?>"  data-id="<?php
                                if (!empty($contact['contact_id'])) {
                                    echo $contact['contact_id'];
                                }
                                ?>" data-path="<?php echo $path; ?>"> <i class="fa fa-remove fa-x redcol"></i> </a> </div>
                        </div>
                                <?php
                                $delete_count++;
                            }
            ...
            <div class="col-xs-12 form-group"> <a id="add_row" class="btn btn-primary align-center" tabindex="21"> <span class="glyphicon glyphicon-plus"></span>
...
?>
                ...
                <div class = "col-xs-12 col-sm-5 col-md-5 form-group">
                    <div class="form-group" id="<?php echo $campaign_id; ?>">
    ...
    <?php foreach ($product_data as $product) { ?>
                ...
                <div class = "">
                    <div class = "col-xs-12 col-sm-7 col-md-7 form-group">
                        ...
                        <textarea class="form-control" rows="4" placeholder="<?= $this->lang->line('description') ?> *" name="description" id="description" tabindex="26"><?php
                    ...
                    <div class = "col-xs-12 col-sm-5 col-md-5 form-group">
                      ...
                      <input type="file" title="Add a File" class="file" id="prospect_files" name="prospect_files[]" multiple tabindex="24">--> 
                        <!-- new code-->
                        <div class="col-xs-12 col-md-12 no-right-pad bd-dragimage">
                            <div class="row"> <div id="dragAndDropFiles" class="uploadArea uploadarea-sm bd-dragimage">
...
//                                $file_img = $campaign_data[0]['file'];
                                                    ...
                                                    <div id="img_<?php echo $image['file_id']; ?>" class="eachImage"> 
                                                      <!--                                            <a class="btn delimg remove_drag_img" href="javascript:;" data-id="img_<?php echo $image['file_id']; ?>" data-href="<?php echo base_url($opportunity_view . '/deleteImage/' . $image['file_id']); ?>">x</a>--> 
                                                        <a class="btn delimg remove_drag_img" href="javascript:;" title="<?= $this->lang->line('delete') ?>" data-name="<?php echo $name; ?>" data-id="img_<?php echo $image['file_id']; ?>" data-path="<?php echo $path; ?>">x</a> <span id="<?php echo $i; ?>" class="preview"> <a href='<?php echo base_url($opportunity_view . '/download/' . $image['file_id']); ?>' target="_blank">
    ...
    if (!empty($prospect_files)) {
        if (count($prospect_files) > 0) {
            foreach ($prospect_files as $files) {
                ...
                ?>
                                <?php if (file_exists($path . '/' . $name)) { ?>
                                                                                                                                                                                                                                                                                                                                                  <li id="img_<?php echo $files['file_id']; ?>"> <a href='<?php echo base_url($opportunity_view . '/download/' . $files['file_id']); ?>' target="_blank"> <?php echo $files['file_name']; ?> </a>
                                    <?php if ($files['upload_status'] == 0) {
                                        ?>
                                                                                                                                                                                                                                                                                                                                                                                                                    <a class="btn delimg" href="javascript:;" data-id="img_<?php echo $files['file_id']; ?>" data-href="<?php echo base_url($opportunity_view . '/deleteImage/' . $files['file_id']); ?>"><i class="fa fa-remove redcol"></i></a>
                                    <?php } ?>
                                                                                                                                                                                                                                                                                                                                                  </li>
                                    <?php
                                }
            ...
            <div class="modal-footer">
                <center>
                    <input type="submit" class="btn btn-primary" name="opportunity_submit" id="opportunity_submit_btn" value="<?= $submit_button_title ?>" tabindex="25"/>
                </center>
            </div>
        </div>
    </div>
...
<script>
    ...
    $('body').delegate('#opportunity_submit_btn', 'click', function () {
        ...
        if ($('#add_opportunity').parsley().isValid()) {
            //disabled submit button after submit
            $('input[type="submit"]').prop('disabled', true);
            $('#add_opportunity').submit();
        }

    });
    $(document).ready(function () {
        //parsley validation
        $('#add_opportunity').parsley();
                        ...
                        buttons: [{
                                ...
                                action: function (dialog) {
                                    if (contact_id) {
                                        $.ajax({
                                            type: "POST",
                                            url: "Opportunity/delete_contact_master/",
...
<script>
    ...
    var config = {
        ...
        uploadUrl: "<?php echo $opportunity_view; ?>/upload_file"				// Server side upload url
    }
    $(document).ready(function () {
        ...
        create_box = function (e, file) {
            ...
            //            console.log(fileext);
            xhr[rand].open("post", "<?php echo base_url('/Opportunity/upload_file') ?>/" + fileext, true);
