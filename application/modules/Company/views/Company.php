...
<div class="row">
    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
        <ul class="breadcrumb nobreadcrumb-bg">
            <li><a href="<?php echo base_url() . 'Support'; ?>"><?= lang('support') ?></a></li>
    ...
    <div class="col-xs-12 col-md-9">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-6 col-sm-6 pull-right text-right">
                <?PHP if (checkPermission('Company', 'add')) { ?>
                    <a data-href="<?php echo base_url('Company/add'); ?>" data-toggle="ajaxModal" class="btn btn-white" aria-hidden="true" data-refresh="true">
...
<script type="text/javascript">
    ...
    $('body').on('click', '#common_tb ul.pagination a.ajax_paging', function (e) {
        $.ajax({
            ...
            success: function (html) {
                $("#common_div").html(html);
                $('#totalCompanyText').text($('#total_account_count').val());
                //    $.unblockUI();
            }
        });
        return false;
