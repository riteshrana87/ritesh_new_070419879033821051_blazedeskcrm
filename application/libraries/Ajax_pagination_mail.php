...
class Ajax_pagination_mail {
    ...
    var $last_tag_open = '&nbsp;';
    var $last_tag_close = '';
    var $cur_tag_open = '&nbsp;<li class="paginate_button active"><a tabindex="0" data-dt-idx="1" aria-controls="example1" href="#"><b>';
...
//        }
        ...
        if ($this->show_count) {
            ...
            $info = '<div class="col-lg-2 form-group bd-in-pagn-msg col-md-2 col-sm-4"><div aria-live="polite" role="status" id="" class="">Message ' . ( $curr_offset + 1 ) . ' to ';
            ...
            $info .= ' of ' . $this->total_rows . ' </div></div> <div class="col-lg-4 form-group col-md-4 col-sm-8"><div ><ul class="bd-inbox-pagin">';
        ...
        if ($this->cur_page > $this->num_links) {
            $linkFirst = ($this->first_link != '') ? $this->first_link : lang('first');
            $output .= $this->first_tag_open . '<li>'
                    . $this->getAJAXlink('', $linkFirst) . '</li>'
...
//                } else {
//                    $n = ($i == 0) ? '' : $i;
//                    $output .= $this->num_tag_open . '<li class="paginate_button previous ">'
...
//        }
        ...
        if (($this->cur_page + $this->num_links) < $num_pages) {
            ...
            $output .= $this->last_tag_open . '<li >' . $this->getAJAXlink($i, $linkLast) . '</li>' . $this->last_tag_close;
        }
        ...
        $output = $this->full_tag_open . $output . $this->full_tag_close . '</ul></div></div>';
