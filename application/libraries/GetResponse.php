...
{	
	 ...
	 * @var string
	 */
	public $apiKey = '48665543b7f194513e43c5f306e50138';
	...
	public function __construct($apiKey = null)
	{
		...
		//$this->apiKey = $apiKey;
                //$this->apiKey = '48665543b7f194513e43c5f306e50138';
	...
	public function getContacts($campaigns = null, $operator = 'CONTAINS', $comparison = '%', $fields = array('name' => true, 'email' => false))
	{
		...
		if($fields['email']) $params['email'] = $this->prepTextOp($operator, $comparison);
                ...
                //added by sanket get only contact added by api.
		$params['origin'] = 'api';
	...
	public function deleteAccountBlacklist($mask)
	{
        ...
        public function create_campaign($campaignName)
	{
            $tmpCampaignName = str_replace(' ','_', $campaignName);
            $params = array('name'=>$tmpCampaignName,
            'from_field'=>'pIc79',
            'reply_to_field'=>'pIc79',
            'confirmation_subject'=>'TfUq',
            'confirmation_body'=>'TfNd','language_code'=>'EN');
	...
	{
		$request  = $this->prepRequest('get_confirmation_subjects');
		$response = $this->execute($request);
		return $response;
	}
	
	public function getConfirmationBodies()
	{
		$request  = $this->prepRequest('get_confirmation_bodies');
		$response = $this->execute($request);
		return $response;
	}
    ...
    {
        $CI = &get_instance();
        $config_api_key= "config_key='get_response_configuration'";
    ...
    public function get_contacts_deleted()
    {
            $request  = $this->prepRequest('get_contacts_deleted');
            $response = $this->execute($request);
            return $response;
    }
}
