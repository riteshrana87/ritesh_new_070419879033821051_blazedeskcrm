...
class Ajax_pagination{
	...
	function create_links()
	{
		...
		if ($this->show_count)
		{
			...
			$info = '<div class="col-sm-5"><div aria-live="polite" role="status" id="example1_info" class="dataTables_info">Showing ' . ( $curr_offset + 1 ) . ' to ' ;
			...
			$info .= ' of ' . $this->total_rows . ' </div></div> <div class="col-sm-7"><div class="dataTables_paginate paging_simple_numbers" id="example1_paginate"><ul class="pagination">';
	...
	function getAJAXlink( $count, $text) {
		...
		if( $this->div == '')
			return '<li class="paginate_button previous disabled"><a class="ajax_paging" href="'. $this->anchor_class . ' ' . $this->base_url . $count . '">'. $text .'</a></li>';
		...
		/*return "<a href=\"javascript:void(0);\"
				...
				. $text .'</a>';*/
		return '<li class="paginate_button previous disabled">'."<a href=". $this->base_url . $count ."
